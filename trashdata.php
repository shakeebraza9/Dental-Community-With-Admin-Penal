...
<div class="index_content mypage">
    <div class="left_right_side">
        ...
        <div class="right_side profile">
            ...
            <div id="tabs-1" aria-labelledby="ui-id-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" aria-hidden="false">

            <div class="cpd-table">
                <div class="cpd-tbl tableStock tableIBMS  table table-hover dTable tableIBMS dataTable no-footer datable table">
                    <table id="selected"  class="cell-border table sTable table-hover">
                        <thead>
                            <tr>
                               <th>No</th>
                               <th>PAGE NAME</th>
