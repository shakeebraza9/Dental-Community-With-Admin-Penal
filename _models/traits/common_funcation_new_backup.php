    ...
    // if($data[0]['shift'] != ''){
        ...
        if($timefrom1 < $timefrom) {
                if($timeto>$currentTime){
                   echo $button = '<a onclick="window.location.href=\'checkinout?type=checkin&shift='."1".'\'">Check In</a>';
                //   echo 1;
                }else{
...
$txt = "'" . $txt . "'";
echo $button = '<a class="topnav_icons" onclick="secure_delete333(' . $txt . '); "><span class="material-symbols-outlined">logout</span></a>';
}
