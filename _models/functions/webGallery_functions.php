...
$html .= "<div class='gallerySingle thumb'>

<div class='gallery_box'>

<a href='$imageLink' rel='gallery' class='grow thumbnail galleryFancyBox_$id' title='$alt'>

<img src='$imageLink' class=''  title='$alt' alt='$alt'/>

</a>

</div><!--gallery_box end-->

<span style=\"margin-top:8px; text-align:center !important;\" class=\"center-block text-center album_name\">

<a href='$imageLink' title='$alt'>$alt</a>
...
$temp .= "  <div class='gallerySingle thumb' id='gallery_$id'>

<div class='gallery_box'>

<a href='$imageR' title='$alt' class='grow thumbnail '>

<img src='$image' class=''  title='$alt'  alt='$alt' />   
...
<a href='$imageR' title='$alt'>   {$album}</a>
