...
<body>
    <div class="result_main">
        <div class="result_top">
            ...
            <div class="gdc">(GDC NO. <?php echo $_POST['cdc'] ?>)</div><br>
                Attended a Training session on the topic of:<br>
            <h2><?php echo $_POST['heading']; ?></h2><div class="on">on</div>
            <h2><?php echo date('d-M-Y'); ?></h2>
        </div>
        <!-- result_top -->
        <div class="result_middle">
            <h5>Aim</h5>
            <p><?php echo $_POST['aim']; ?></p>
            <h5>Objectives</h5>
            <p><?php echo $_POST['obj']; ?></p>
            <h5>Learning Content</h5>
            <p><?php echo $_POST['lc']; ?></p>
            <h5>Development Outcomes</h5>
            <p><?php echo $_POST['do']; ?></p>
        </div>
        <!-- result_middle -->
        <div class="result_bottom">
               <?php if ($_POST['minutes'] == '60' ) { ?>
            
            <img src="<?php echo WEB_URL ?>/webImages/stamp1.png">
       <?php } else if ($_POST['minutes'] == '120' ) { ?>
