...
$remainingHours = $requiredHours-$completedHours;
                ...
                <div class="row mainClass">
                    <div class="col-md-4">
                        <div class="cpd-inner-box">
                            <div class="cpd-box-content">
                                <h5>Required CE Hours</h5>
                                <h3><?php echo $requiredHours ?></h3>
                            </div>
                            <div class="imgdiv">
                                <span class="avatar_title">
                                    <img src="<?= WEB_URL?>/webImages/required.png" alt="Remaining CPD Hours">
                                </span>
                            </div>
                            <div class="line"></div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="cpd-inner-box">
                            <div class="cpd-box-content">
                                <h5>Completed CE Hours</h5>
                                <h3><?php echo $completedHours ?></h3>
                            </div>
                            <div class="imgdiv">
                                <span class="avatar_title">
                                    <img src="<?= WEB_URL?>/webImages/completed.png" alt="Completed CPD Hours">
                                </span>
                            </div>
                            <div class="line"></div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="cpd-inner-box">
                            <div class="cpd-box-content">
                                <h5>Remaining CE Hours</h5>
                                <h3><?php echo $remainingHours ?></h3>
                            </div>
                            <div class="imgdiv">
                                <span class="avatar_title">
                                    <img src="<?= WEB_URL?>/webImages/remaininghours.png" alt="Remaining CPD Hours">
                                </span>
                            </div>
                            <div class="line"></div>
                        </div>
  ...
  alert("Sorry, the CPD certificates are currently under maintenance work. Please try back later Sorry for the inconvenience !");
            ...
            <div class="cpd-courses">
                <div class="p-heading"><h3>Courses</h3></div>
