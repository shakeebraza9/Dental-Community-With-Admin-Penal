...
<div class="index_content health_form">
    <!-- <div class="left_right_side"> -->
        ...
        <div class="right_side">
            <div class="right_side_top">
                <div class="change-session" style="display: none;">
                <?php
  ...
  if($_SESSION['currentUserType'] != 'Employee' || $_SESSION['currentUserType'] != 'master' || @$_SESSION['superUser']['hrrota'] == 'full' || @$_SESSION['superUser']['hrrota'] == 'edit'){
                  ?>
                   ...
                   <form action="rota" method="get" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-12 col-md-6">
                            <label>Create Weekly Schedule of</label>
                        ...
                        <div class="form-group col-12" style="display: inherit;">
                            ...
                            <input style="margin-top: 0; margin-right: 60px;" type="submit" class="submit_class" value="Create Schedule" name="submit">
...
// }
               if(!isset($_GET['date'])){
                 ...
                 echo "<h2 class='h2Heading'>Published Schedule</h2>";
                        // echo"
                ...
                echo"
                    <div class='m_next_pre'>   
                     ...
                     if($_SESSION['currentUserType'] != 'Employee'|| $_SESSION['currentUserType'] != 'master' || @$_SESSION['superUser']['hrrota'] == 'full' || @$_SESSION['superUser']['hrrota'] == 'edit'){
                        ...
                        echo "</div>";
                        echo "<div class='rota_btn_flex'> <div class='m_next_pre_'> 
                            ...
                            <input class='wrdatepicker rotaSearch' type='text' name='date2'  autocomplete='off' readonly style='width: auto;' placeholder='Search' value='".@$_GET['datev']."'>
                            <i class='fa fa-calendar' aria-hidden='true' style='position: relative;right: 21px;'></i>
                            <a class='submit_class rota-btn' href='rota?datev=".date('d-M-Y',strtotime('+7 day '.$date))."&rotaweeklysubmit=Create+Weekly+Rota' style='padding: 0px 25px;width:12%; margin-left:-7px'>Next</a>
                            </div></div>
                            ...
                            <a class='submit_class filter-rota' href='rota?date2=".date('d-M-Y',strtotime($date))."&date=".date('d-M-Y',strtotime($date))."&type=reset'>Reset Rota</a></div></div>";    
