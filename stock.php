...
<div class="imgdiv">
    <span class="avatar_title">
        <img src="<?= WEB_URL?>/webImages/shopping basket.png">
    </span>
</div>
<div class="line"></div>
</div>
...
<div class="imgdiv">
    <span class="avatar_title">
        <img src="<?= WEB_URL?>/webImages/minimum stock.png">
    </span>
</div>
 ...
 ?>
   ...
   <div class="col-md-4">
                        <div class="cpd-inner-box">
                            ...
                            <div class="imgdiv">
                                <span class="avatar_title">
                                    <img src="<?= WEB_URL?>/webImages/expiration-date.png">
                                </span>
                            </div>
...
$proProDesc= $productClass->proProDesc($value['id']);
// $proProDesc= $productClass->proProDesc($value['qty_product_id']); show and error
