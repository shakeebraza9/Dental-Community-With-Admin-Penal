...
$msg = "";
$chk = $functions->submitmySafetyData();
if($chk){
    $msg = "File Submit Successfully";
} 
    if($_GET['category'] != 'Safety-Data'){$_GET['category'] = 'Safety-Data';}
...
<div class="index_content mypage resources">
    <!-- <div class="left_right_side"> -->
        ...
        <div class="right_side">
            <!-- <div data-toggle="tooltip" title="Help Video" style="position: absolute;top: 10px;right: 15px;margin: auto;display: block;" class="help" onclick="video('CfAI0hen4tc')"><i class="fa fa-question-circle"></i></div> -->
                 <?php if($_GET['category'] == 'Safety-Data'){ ?>
                    <h3 class="main-heading_">Safety Data</h3><?php }else{
                        ?>
                    <h3 class="main-heading_">Safety Data</h3><?php 
                    } ?>
             <div class="right_side_top">
                ...
                <!--   <a href="javascript:;" onclick="uploadsafetydata('<?php //echo $category;?>')">Upload Template</a>-->
                <!--         </div>-->
            ...
            <div class="mr compliance-template-card">
                 ...
                 <?php 
                    ...
                    if(isset($_GET['category']) && isset($_GET['sub_category'])){
                        ...
                        $functions->safety_innner_ui($category,$sub_category,$_SESSION['currentUser']);
                    }
                    else if(isset($_GET['category']) ){
                         $functions->safetyData($category,$_SESSION['currentUser']);
                    }
                    else{
    ...
    function deleteuserSafety(ths){
        ...
        if(secure_delete()){
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax_call.php?page=deleteuserSafety',
                data: { id:id }
            }).done(function(data)
                {
