...
<div class="form-group col-12 col-sm-12 col-md-6 mr-2" style=""><label>Type of incident (refer to policy if unsure)</label>
...
<div class="form-group label_50_per col-12 col-sm-12 col-md-6 mr-2"><label>Location:</label><input class="textbox50Per" name="incident_location" type="text" placeholder=" " value=""></div>

<div class="form-group label_50_per col-12 col-sm-12 col-md-6 mr-2"><label>Address:</label><input class="textbox50Per" name="incident_address" type="text" placeholder=" " value=""></div>
<div class="form-group label_50_per col-12 col-sm-12 col-md-6 mr-2"><label>Date:</label><input class="textbox50Per" name="incident_date" type="date" placeholder=" " value=""></div>
<div class="form-group label_50_per col-12 col-sm-12 col-md-6 mr-2"><label>Time of incident</label><input class="textbox50Per" name="incident_time" type="text" placeholder="24h clock" value=""></div>
...
<div class="form-group col-12 col-sm-12 col-md-6 mr-2"><label>Immediate actions taken</label><input name="immediate_action_taken" type="text" placeholder="to reduce impact of incident and/or risk of reoccurrence. Include who took actions" value=""></div>
<div class="form-group col-12 col-sm-12 col-md-6 mr-2"><label>Details of any external agencies involved</label><input name="detail_of_any_external_agency_involved" type="text" placeholder="include staff names, contact details, advice given and actions taken" value=""></div>



<div class="form-group col-12 col-sm-12 col-md-6 mr-2"><label>Cause of incident</label><input name="cause_of_incident" type="text" placeholder="including any relevant events leading up to the incident" value=""></div>


<div class="form-group col-12 col-sm-12 col-md-6 mr-2"><label>Management actions</label><input name="management_action" type="text" placeholder="" value=""></div>




<div class="form-group-flex">
                        <input type="file" id="upload" hidden="" name="imageFx">
                        <label for="upload" class="upload_btn">Upload File: </label>
 ...
 <div class="footer-bottom">
                    <div class="form-group">
                        <input type="submit" name="submit" class="submit_btn" id="signup_btn" value="Submit Information">
                    </div>
                </div>
...
echo "<td ><div class='action_flex'> <button class='ablue' data-toggle='tooltip' title='Change Status' style='cursor: pointer;' id='" . $value['id'] . "' onClick='changeStatuses(this.id)'>";

// echo $tp;
echo "<i class='fas fa-sync-alt'></i>";
echo "</button>";
echo "<button class='ablue' data-toggle='tooltip' title='Delete' style='cursor: pointer;' id='" . $value['id'] . "' onClick='changeStatusesDel(this.id)'><i class='fas fa-trash'></i></button>";
...
echo "<button class='ablue' data-toggle='tooltip' title='View all details' style='cursor: pointer;' id='" . $value['id'] . "' onClick='viewComplaintIssue(this.id)'><i class='fas fa-clipboard'></i></button>";
}else{

echo "<button class='ablue' data-toggle='tooltip' title='View all details' style='cursor: pointer;' id='" . $value['id'] . "' onClick='viewIncidentIssue(this.id)'><i class='fas fa-clipboard'></i></button>";
...
echo "<button class='ablue' title='View file' data-toggle='tooltip' style='cursor: pointer;' id='" . $value['id'] . "' onClick='viewComplainFile(this.id)'><i class='fas fa-eye'></i></button>";
}else{
...
echo '<a class="ablue" href="printReports.php?id=' . base64_encode($value['id']) . ':Complaint Form" target="_blank" data-toggle="tooltip" title="Print/Save"><i class="fas fa-print"></i></a>';
}else{

echo '<a class="ablue" href="printReports.php?id=' . base64_encode($value['id']) . ':Serious Accident Incident Form" target="_blank" data-toggle="tooltip" title="Print/Save"><i class="fas fa-print"></i></a>';
}
