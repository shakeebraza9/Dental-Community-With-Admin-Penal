...
class setting extends object_class{
    ...
    public function __construct(){
        ...
        $_w['Twitter Name'] = '';
        $_w['Available Positions'] = '';
        $_w['Enter comma seperated values eg: position one,position two,three'] = '';
        ...
        $_w['Enter comma seperated values eg: status one,status two,three'] = '' ;
        $_w['Employment Status'] = '' ;
        $_w['Experience Level'] = '' ;
        $_w['Enter comma seperated values eg: status 1 year,2 year,3 year'] = '' ;
        $_w['Education Level'] = '' ;
        $_w['Enter comma seperated values eg: one, two, three'] = '' ;
        $_w['Finantial Reports'] = '' ;
        $_w['Enter comma seperated values eg: yearly, half yearly, monthly'] = '' ;
        $_w['Email Us'] = '' ;
        $_w['Enter Email Address'] = '' ;
        $_w['test category'] = '' ;
        $_w['Documents Category'] = '' ;
        $_w['Map'] = '' ;
        $_w['Account Role'] = '' ;
        $_w['Leave type'] = '' ;
        $_w['VAT Percent'] = '' ;
 ...
 $_w['Action'] = '';
        ...
        if(!empty($_POST['setting'])){
            ...
            try{
                ...
                if($submitSuccessfully){
                    ...
                    $this->functions->setlog(_uc($_e['Setting']),'IBMS',"0",_uc($_e["IBMS Setting Update Successfully"]),false);
                }else{
    ...
    public function hardWordsEdit(){
        global $_e;
        $id =   $_GET['editId'];
        $sql  = "SELECT * FROM hardwords WHERE id =  ? ";
...
htmlspecialchars($en);
    ...
    public function socialSetting($settingData){
        ...
        <?php } ?>
          ...
          <?php if($this->functions->developer_setting('whatsapp')=='1'){ ?>
            <div class="form-group">
                <label class="col-sm-4 col-md-3 control-label" >Whatsapp</label>
                <div class="col-sm-8 col-md-9">
                    <?php
                    $temp = $this->getIBMSSettingArrayValue('whatsapp',$settingData);
                    ?>
                    <input type="text" value="<?php echo $temp; ?>" name="setting[whatsapp]" id="whatsapp" class="form-control">
                </div>
            </div>
        <?php } ?>
        ...
        <?php if($this->functions->developer_setting('tumbler')=='1'){ ?>
            <div class="form-group">
                <label class="col-sm-4 col-md-3 control-label" >Tumbler</label>
                <div class="col-sm-8 col-md-9">
                    <?php
                    $temp = $this->getIBMSSettingArrayValue('tumbler',$settingData);
                    ?>
                    <input type="text" value="<?php echo $temp; ?>" name="setting[tumbler]" id="tumbler" class="form-control">
                </div>
            </div>
        <?php } ?>
    ...
    public function generalSetting($settingData){
        ...
        $valForm = $this->getIBMSSettingArrayValue('Phone',$settingData);
        $form_fields[] = array(
            'label' => 'Contact No',
            'name' => 'setting[Phone]',
            'value' => $valForm,
        ...
        $valForm = $this->getIBMSSettingArrayValue('bEmail',$settingData);
        $form_fields[] = array(
            'label' => 'Booking Email',
            'name' => 'setting[bEmail]',
            'value' => $valForm,
        ...
        //   $valForm = $this->getIBMSSettingArrayValue('ccEmail',$settingData);
        // $form_fields[] = array(
        //     'label' => 'Career Form Email',
        //     'name' => 'setting[ccEmail]',
        //     'value' => $valForm,
        //     'type' => 'text',
        //     'class' => 'form-control'
        // );
        ...
        // $valForm = $this->getIBMSSettingArrayValue('Map',$settingData);
        // $form_fields[] = array(
        //     'label' => _uc($_e['Map']),
        //     'name' => 'setting[Map]',
        //     'value' => $valForm,
        ...
        $valForm = $this->getIBMSSettingArrayValue('passing percent',$settingData);
        $form_fields[] = array(
            'label' => _uc('Passing Percent'),
            'placeholder' => _fu($_e['Enter comma seperated values eg: position one,position two,three']),
            'name' => 'setting[passing percent]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control'
        );

        $valForm = $this->getIBMSSettingArrayValue('cpd_hours',$settingData);
        $form_fields[] = array(
            'label' => _uc('CPD Hours'),
            'name' => 'setting[cpd_hours]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        );
        
        $valForm = $this->getIBMSSettingArrayValue('test_categories',$settingData);
        $form_fields[] = array(
            'label' => _uc($_e['test category']),
            'placeholder' => _fu($_e['Enter comma seperated values eg: position one,position two,three']),
            'name' => 'setting[test_categories]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control'
        );
        $valForm = $this->getIBMSSettingArrayValue('documents_Category',$settingData);
        $form_fields[] = array(
            'label' => _uc($_e['Documents Category']),
            'placeholder' => _fu($_e['Enter comma seperated values eg: position one,position two,three']),
            'name' => 'setting[documents_Category]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control'
        );
        
          $valForm = $this->getIBMSSettingArrayValue('course_dental_category',$settingData);
        $form_fields[] = array(
            'label' => _uc($_e['Couse Dental Category']),
            'placeholder' => _fu($_e['Enter comma seperated values eg: position one,position two,three']),
            'name' => 'setting[course_dental_category]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control'
        );

        // $valForm = $this->getIBMSSettingArrayValue('employment_status',$settingData);
        // $form_fields[] = array(
        //     'label' => _uc($_e['Employment Status']),
        //     'placeholder' => _fu($_e['Enter comma seperated values eg: status one,status two,three']),
        //     'name' => 'setting[employment_status]',
        //     'value' => $valForm,
        //     'type' => 'text',
        //     'class' => 'form-control'
        // );

        // $valForm = $this->getIBMSSettingArrayValue('education_level',$settingData);
        // $form_fields[] = array(
        //     'label' => _uc($_e['Education Level']),
        //     'placeholder' => _fu($_e['Enter comma seperated values eg: one, two, three']),
        //     'name' => 'setting[education_level]',
        //     'value' => $valForm,
        //     'type' => 'text',
        //     'class' => 'form-control'
        // );

        // $valForm = $this->getIBMSSettingArrayValue('experience_level',$settingData);
        // $form_fields[] = array(
        //     'label' => _uc($_e['Experience Level']),
        //     'placeholder' => _fu($_e['Enter comma seperated values eg: status 1 year,2 year,3 year']),
        //     'name' => 'setting[experience_level]',
        //     'value' => $valForm,
        //     'type' => 'text',
        //     'class' => 'form-control'
        // );

        // $valForm = $this->getIBMSSettingArrayValue('financial_positions',$settingData);
        // $form_fields[] = array(
        //     'label' => _uc($_e['Finantial Reports']),
        //     'placeholder' => _fu($_e['Enter comma seperated values eg: yearly, half yearly, monthly']),
        //     'name' => 'setting[financial_positions]',
        //     'value' => $valForm,
        //     'type' => 'text',
        //     'class' => 'form-control'
        // );
        ...
        //   $valForm = $this->getIBMSSettingArrayValue('latestBlogLimit',$settingData);
        // $form_fields[] = array(
        //     'label' => _uc($_e['How Many Blogs Show?']),
        //     'name' => 'setting[latestBlogLimit]',
        //     'value' => $valForm,
        //     'type' => 'text',
        //     'class' => 'form-control',
        //     'min'   => '7'
        ...
        $valForm = $this->getIBMSSettingArrayValue('eventcategory',$settingData);
        $form_fields[] = array(
            'label' => _uc($_e['Event Categories']),
            'name' => 'setting[eventcategory]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        );

        $valForm = $this->getIBMSSettingArrayValue('safetyDataCategory',$settingData);
        $form_fields[] = array(
            'label' => _uc('Safety Data Categories'),
            'name' => 'setting[safetyDataCategory]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        );

         $valForm = $this->getIBMSSettingArrayValue('faqcategory',$settingData);
        $form_fields[] = array(
            'label' => _uc($_e['FAQ Categories']),
            'name' => 'setting[faqcategory]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        );
        $valForm = $this->getIBMSSettingArrayValue('leavetype',$settingData);
        $form_fields[] = array(
            'label' => _uc('Leave type'),
            'name' => 'setting[leavetype]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        ); 
        
        $valForm = $this->getIBMSSettingArrayValue('VAT_Percent',$settingData);
        $form_fields[] = array(
            'label' => $_e['VAT Percent'],
            'name' => 'setting[VAT_Percent]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        );
        
        $valForm = $this->getIBMSSettingArrayValue('account_role',$settingData);
        $form_fields[] = array(
            'label' => _uc($_e['Account Role']),
            'name' => 'setting[account_role]',
            'value' => $valForm,
            'type' => 'text',
            'class' => 'form-control',
        );
