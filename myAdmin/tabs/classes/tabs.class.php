...
$_e    =   $this->dbF->hardWordsMulti($_w,$adminPanelLanguage,'Admin Slider');
...
<input type="text" name="tabs_heading['.$lang[$i].']" value="'.@$tabs_heading[$lang[$i]].'" class="form-control" placeholder="'. _uc($_e['Package Title']) .'">
</div>
</div>';
...
//     echo '<div class="form-group">
//             <label class="col-sm-2 col-md-3  control-label">'. _uc($_e['Button Link']) .'</label>
//             <div class="col-sm-10  col-md-9">
//                 <input type="url" name="tabs_link" value="'.@$data['tabs_link'].'" class="form-control" placeholder="'. _uc($_e['Button Link']) .'">
//             </div>
//         </div>';
//Link
@$link = $data['tabs_link'];
...
<input type="url" value="'.$link.'" name="tabs_link" class="pastLinkHere form-control" placeholder="'. _uc($_e['Button Link']) .'">
