    ...
    if($edit){
        ...
        echo '<h3>Personal Details</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control"  value="'.@$this->webUserInfoArray($userInfo,'kin_name').'" name="signUp[kin_name]" placeholder="Emergency Contact Name" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control"  value="'.@$this->webUserInfoArray($userInfo,'kin_phone').'" name="signUp[kin_phone]" placeholder="Emergency Contact Number" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Empolyment Type</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Vacation Allowance</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control"  value="'.@$this->webUserInfoArray($userInfo,'holiday_entitlement').'" name="signUp[holiday_entitlement]" placeholder="Vacation Allowance" >
                    </div>
                </div>
            
                <div class="form-group">
                    <label class="col-sm-3 control-label">Sick Days Allowance</label>
                    <div class="col-sm-9">
                        <input type="number" min="1" max="99" class="form-control"  value="'.@$this->webUserInfoArray($userInfo,'holiday_entitlement').'" name="signUp[holiday_entitlement]" placeholder="Sick Days Allowance" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Cycle Start Date</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control date"  value="'.@$this->webUserInfoArray($userInfo,'cpd_start_date').'" name="signUp[cpd_start_date]" placeholder=" Cycle Start Date" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control"  value="'.@$this->webUserInfoArray($userInfo,'gdc_number').'" name="signUp[gdc_number]" placeholder="Number" >
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-3 control-label">Allow My Practice Manager to view my certificates</label>
                    <div class="col-sm-9">
                        <label class="radio-inline">
