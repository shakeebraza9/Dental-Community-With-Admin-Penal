...
<h2 class="sub_heading"><?php echo _uc($_e['Manage Event Forms']); ?></h2>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist">
        ...
        <li><a href="#newPage" role="tab" data-toggle="tab"><?php echo _uc($_e['Add New Event Forms']); ?></a></li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active container-fluid" id="home">
            <h2  class="tab_heading"><?php echo _uc($_e['Active Event Forms']); ?></h2>
            <?php $eventForm->eventFormView();  ?>
        </div>

        <div class="tab-pane fade in container-fluid" id="draft">
            <h2  class="tab_heading"><?php echo _uc($_e['Draft Event Forms']); ?></h2>
            <?php $eventForm->eventFormDraft();  ?>
        </div>
