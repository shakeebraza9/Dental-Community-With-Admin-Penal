...
echo '<div class="form-group">
<label class="col-sm-2 col-md-3  control-label">'. _uc('heading 2') .' </label>
<div class="col-sm-10  col-md-9">
'.$lay3_Status.'
</div>
</div>';
...
// $lay1_Status = '
// <textarea  name="layer1['.$lang[$i].']" id="layer1" maxlength="500" class="layer1 form-control" placeholder="'. _uc('Link Text') .'">'.@$layer1[$lang[$i]].'</textarea>';
...
<div class="col-sm-10  col-md-9">
<div class="input-group">
<input type="url" value="'.$link.'" name="banner_link" class="pastLinkHere form-control" placeholder="'. _uc($_e['Banner Link']) .'">
