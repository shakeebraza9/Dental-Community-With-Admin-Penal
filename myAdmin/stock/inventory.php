...
?>
 ...
 <!--        <li ><a href="#ViewInventoryDetail" role="tab" data-toggle="tab"><?php echo _uc($_e['Product Inventory Detail']); ?></a>
        </li>
         <li ><a href="#ViewInventoryduplicateentry" role="tab" data-toggle="tab"><?php echo _uc($_e['View Inventory Duplicate Entry']); ?></a>
        </li>
   ...
   <!--          <small><a href="-stock?page=inventory&cleanInventory"
            ...
            <?php $inventory->showProductInventory();
              $inventory->functions->simpleModal('stock/stock_ajax.php?page=InventoryInfo','Inventory Detail Info','inventory','.inventoryinfo',false);
             ?>

        </div>  
 

         <div class="tab-pane fade container-fluid" id="ViewInventoryDetail" >
            <h2 class="tab_heading"><?php echo _uc($_e['View Product Stock Inventory Detail']); ?></h2>
            <small><a href="-stock?page=inventory&cleanInventory"
                      class="btn btn-info btn-sm"><?php echo _n($_e['Stock Update if needed']); ?></a></small>
            <small>{{inventoryProducts}}</small>
            <?php $inventory->showProductInventory_detail(); ?>
        </div>   



        <div class="tab-pane fade container-fluid" id="ViewInventoryduplicateentry">
            <h2 class="tab_heading"><?php echo _uc($_e['View Inventory Duplicate Entry']); ?>
                <small>
                    <small> <?php echo _uc($_e['Duplicate Entry']); ?></small>
                </small>
            </h2>
             <?php // $inventory->showproductDuplicateEdit(); ?>
        </div> 

 <div class="tab-pane fade container-fluid" id="AddMinimumStocktoNotify">
            <h2 class="tab_heading"><?php echo _uc($_e['Add Quantity']); ?>
                <small>
                    <small> <?php echo _uc($_e['Minimum Stock to Notify']); ?></small>
                </small>
            </h2>
