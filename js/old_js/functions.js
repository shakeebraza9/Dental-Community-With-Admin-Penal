...
function uploadcompliancetemplate() {
    $(".myevents-form").empty(), $(".fixed_side").toggleClass("fixed_side_"), $(".myevents-div").toggleClass("myevents-div_"), $(".myevents-form").load("uploadComplianceTemplateForm.php", (function() {
        $(".myevents-div #loader").fadeOut(600), $(".background_side").fadeOut(600)
    })), $("[title='chat widget']").parent("div").hide()
}
...
function faqview(e) {
    $(".myevents-form").empty(), $(".myevents-div").addClass("myevents-div_"), $(".fixed_side").addClass("fixed_side_"), $(".myevents-div").removeClass("orangeborder"), $(".myevents-form").load("faqView.php?id=" + e, (function() {
        $(".myevents-div #loader").fadeOut(600), $(".background_side").fadeOut(600)
    }))
}
...
function stickynotesClick() {
    $(".saad").toggleClass("content_Sticky_"), $(".contentSticky").show()
}
$((function() {
