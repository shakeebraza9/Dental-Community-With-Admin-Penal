...
<head>
    ...
    * {
    ...
    .result_main {
        ...
        position: relative;
        margin: 120px auto;
        background-image: url(webImages/certificate);
    ...
    <div class="result_main">
        <div class="result_top">
            ...
            <!-- <div class="gdc">(GDC NO. <?php echo $gdc ?>)</div> --><br>
                Attended a CE session on the topic of:<br>
        ...
        <div class="result_bottom">
            ...
            <img src="<?php echo WEB_URL ?>/webImages/stamp1.png" style="display: none;">
       <?php } else if ($minutes == '120' ) { ?>
            
            <img src="<?php echo WEB_URL ?>/webImages/stamp2.png" style="display: none;">
       ...
       <?php } ?>            
            ...
            <table width="100%"><tr>
        <td>Valid Till <?php echo date('d-M-Y', strtotime($expiry_date)); ?>. <!-- <strong>This CPD is subject to quality assurance by<img src="<?= WEB_URL?>/webImages/signsaba.jpg" style="width: 80px;position: absolute;display: initial;margin: 0;bottom: 30px; display: none;"> </strong> --><!-- <br>We confirm that the information provided on this certificate is full and accurate. --></td></tr></table>
            <!-- <hr> -->
        </div>
        <!-- result_bottom -->
    </div>
