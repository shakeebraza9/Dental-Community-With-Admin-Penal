...
// var_dump( $_SESSION['currentUserType']);
?>
<div class="index_content mypage">
    <div class="left_right_side">
        ...
        <div class="right_side">
            <div data-toggle="tooltip" title="Help Video" class="help"  style="position: absolute;top: 0px;right: 15px;margin: auto;display: block;" onclick="video('EJUtPIhK-Bg')"><i class="fa fa-question-circle"></i></div>
           ...
           <!--  <a style="" href="<?php echo WEB_URL; ?>/action-plan" class=""><i class="fas fa-plus"></i> <span>Action Plan</span></a>
            <div class="calendar"> -->
                ...
                <a href="javascript:;" onclick="myevents___()" class="myevents"><i class="fas fa-plus"></i> <span>Add Events</span></a>
            ...
            <!--     <a style="position: absolute;right: 180px;" href="javascript:;" onclick="customlog()" class="myevents"><i class="fas fa-plus"></i> <span>Custom Log</span></a> -->
                ...
                <?php if($_SESSION['currentUserType'] !='Employee' || @$_SESSION['superUser']['ccalendar'] == 'edit' || @$_SESSION['superUser']['ccalendar'] == 'full') { 
                    ...
                    if(!empty($data)){
                ?>
                <button class="submit_class" type="button" onclick="eventsAll()" style="height: auto;display: inline-block;max-width: unset;width: unset;">Submit all events (Daily/Weekly)</button>
                <?php }} ?>
                ...
                <div class="col44">
                    ...
                    <div id="tabs">
                        ...
                        <?php if($_SESSION['currentUserType'] != 'Employee' || $_SESSION['superUser']['ccalendar'] != '0'){ ?>
                        <div id="tabs-1">
                            <div class="col4_line" style="font-size: 16px;font-weight: bold;color: #2a3042;">
                                <span style="position: relative;top: -5px;left: -5px;"><img src="webImages/t-icon.png" alt=""></span>Upcoming Events.
                            </div>
                            <!-- col4_line close -->
                            <div class="col4_main" >
                        ...
                        <div id="tabs-2">
                            <div class="col4_line" style="font-size: 16px;font-weight: bold;color: #2a3042;">
                                <span style="position: relative;top: -5px;left: -5px;"><img src="webImages/t-icon.png" alt=""></span>Activities are overdue if not completed by the start of the following month.
                            </div>
                            <!-- col4_line close -->
                            <div class="col4_main">
                        ...
                        <div id="tabs-3">
                            <div class="col4_line" style="font-size: 16px;font-weight: bold;color: #2a3042;">
                                <span style="position: relative;top: -5px;left: -5px;"><img src="webImages/t-icon.png" alt=""></span>In Process Events.
                            </div>
                            <!-- col4_line close -->
                            <div class="col4_main">
                       ...
                       <div id="tabs-4">
                            <div class="col4_line" style="font-size: 16px;font-weight: bold;color: #2a3042;">
                                <span style="position: relative;top: -5px;left: -5px;"><img src="webImages/t-icon.png" alt=""></span>Completed Events.
                                <a href="<?php echo WEB_URL."/completeallEvent" ?>" target="_blank" style="float: right; margin: 1px 10px !important;position: relative;display: inline-block;vertical-align: middle;color: #0b0b0b;font-weight: bold;font-size: 14px;">Show All Event</a>
                        ...
                        <div id="tabs-5">
                            <div class="col4_line" style="font-size: 16px;font-weight: bold;color: #2a3042;">
                                <span  style="position: relative;top: -5px;left: -5px;"><img src="webImages/t-icon.png" alt=""></span>My Events.
                                <a href="<?php echo WEB_URL."/completeallMyEvent" ?>" target="_blank" style="float: right; margin: 1px 10px !important;position: relative;display: inline-block;vertical-align: middle;color: #0b0b0b;font-weight: bold;font-size: 14px;">Show All My Events</a>
                            </div>
                            <!-- col4_line close -->
...
$('#calendar').fullCalendar({
    ...
    eventMouseover: function(data, event) {
        if (data.description == "" || data.description == null) {
            ...
            dsc = '<br><span>description :</span> ' + data.description;
        }
        if (data.due_date == "" || data.due_date == null) {
            due = "";
        } else {
            due = '<br><span>Due Date :</span> ' + data.due_date;
        }
        if(data.start == "" || data.start == null){
            ...
            var dateStart = new Date(startDate.getTime() - (startDate.getTimezoneOffset() * 60000 ))
                    .toISOString()
                    .split("T")[0];
            start = '<br><span>Start Date :</span> ' + dateStart;
        }
        if(data.end == "" || data.end == null){
            ...
            var dateEnd = new Date(endDate.getTime() - (endDate.getTimezoneOffset() * 60000 ))
                    .toISOString()
                    .split("T")[0];
            end = '<br><span>End Date :</span> ' + dateEnd;
        }
  ...
  </div><span>title :</span>  ${data.title} <br><span>Category :</span>  ${data.category} ${due} <br><span>status :</span>   ${data.status}  ${dsc}  ${start}  ${end}  </div></div>`;
