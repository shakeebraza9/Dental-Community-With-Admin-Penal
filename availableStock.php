...
if($seo['title']==''){
$seo['title'] = $dbF->hardWords('Available Stock Listing',false);
}
...
<div class="resources_search crm_search av_stock">
...
<div class="cpd-table">
<h3>Available Stock Products List</h3>
...
$user = intval($_SESSION['currentUser']);
 ...
 $sql = "SELECT * FROM `product_inventory`  WHERE `qty_store_id`='$user' AND `qty_item` !='' AND `qty_item` !='0' ORDER BY `product_inventory`.`qty_item` DESC"; //
