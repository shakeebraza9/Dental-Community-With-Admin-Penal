...
?>
                        ...
                        <div class="form-group">
                            <label for="tags" class="label3">Name of Review :</label>
                            <input type="text" name="title" value="" id="tags" class="form-control">
                        </div>
                        </div>
                        <!-- form-group -->
                        ...
                        <div class="form-group">
                        	<!--<label>&nbsp;</label>-->
                            <input style="margin-top: 0" type="submit" class="submit_btn" id="signup_btn" value="Create Review Form" name="submit">
                        </div>
                        <!-- form-group -->
                    </div>
                </form>
...
?>
                        ...
                        <div class="col-12">
                        	<div class="form-group-flex">
                        <div class="form-group">
                            <label for="tags" class="label3">Create Review Question :</label>
                            <input id="tags"class="form-control" type="text" name="ques" value="" placeholder="Create Review Question">
                        </div>
                        </div>
                        <!-- form-group -->
                        <div class="form-group-flex">
                        <div class="form-group">
                            <label for="tags" class="label3">Question Caption:</label>
                            <input id="tags"class="form-control" type="text" name="qc" value="">
                        </div>
                        </div>
                        <!-- form-group -->
                        <div class="form-group-flex">
                        <div class="form-group">
                            <label for="tags" class="label3">Very Bad :</label>
                            <input id="tags"class="form-control" type="text" name="t0" value="">
                        </div>
                        </div>
                        <!-- form-group -->
                         <div class="form-group-flex">
                        <div class="form-group">
                            <label for="tags" class="label3">Excellent :</label>
                            <input id="tags"class="form-control" type="text" name="t1" value="">
                        </div>
                        </div>
                        <!-- form-group -->
                        <div class="footer-bottom">
                    	</div class="form-group">
                    	<input type="submit" class="submit_btn" id="signup_btn"  value="Add New Question" name="submit">
                    	</div>
                    	</div>
                    </div>
                </form>
