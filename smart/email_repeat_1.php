...
echo $content = "<b>Overdue Events</b>$overdueEvent<b>Due Events</b>$dueEvent";
exit;
$subject = $row['subject'];
$msg = $row['message'];
...
$array   = array($id, 'weeklyEmail',$subject,$email, $content, $functions->getUserPlayerId($id));
$dbF->setRow($sql, $array);

$sql = "INSERT into `email_queue` (`email_to`,`subject`,`message`) VALUES (?,?,?)";
$dbF->setRow($sql, array($email,$subject,$content));
