 ...
 */
! function(e) {
	void 0 == e.fn.ajaxForm && e.getScript("js/jquery.form.js");
	var a = {};
	a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
		...
		function o(a, t, r) {
			...
			$('.datepicker').datepicker({ dateFormat: 'd-M-yy', changeMonth: true, changeYear: true,yearRange: '-80:+20',showButtonPanel:true});
...
$('.customBtn').show();
		...
		var w = e.extend({
			...
			uploadStr: "<i class='fas fa-upload'></i>",
			abortStr: "Abort",
			cancelStr: "Cancel",
			deleteStr: "Delete",
			doneStr: "Done",
