...
if(isset($_GET['inv'])){
    $invoiceId  =   $_GET['inv'];
    $sql        = "SELECT * FROM `order_invoice` WHERE order_invoice_pk = '?' AND orderUser = '$orderUser'";
    $orderInvoice   =   $dbF->getRow($sql,array($invoiceId));
    if(!$dbF->rowCount){
...
$token
    <div class='form1  fadeInUp' id="sender_area" >
    ...
    <div class="navbar-inverse bg-black" style="color:#fff">$senderInfoT</div>
        ...
        <input type="text" class="form_field form-control" value="$uName" name="sender_name" id="sender_name" required="" />
        </div><!--form_fill end-->

        <div class='form_fill'>
         <div class='form_text'>$emailT<span>*</span></div>
         <input type="email" class="form_field form-control" value="$uEmail" name="sender_email" id="sender_email" />
        </div><!--form_fill end-->

        <div class='form_fill'>
         <div class='form_text'>$addressT<span>*</span></div>
         <textarea class="form_field form-control" name="sender_address" id="sender_address" required >$uAddress</textarea>
        </div><!--form_fill end--> 

        <div class='form_fill'>
         <div class='form_text'>$zipcodeT<span>*</span></div>
         <input type="text" class="form_field form-control" name="sender_post" id="sender_post" required="" value="$uPost" />
        </div><!--form_fill end--> 

        <div class='form_fill'>
         <div class='form_text'>$CityT<span>*</span></div>
         <input type="text" class="form_field form-control" name="sender_city" id="sender_city" value="$uCity" required />
        </div><!--form_fill end--> 

        <div class='form_fill'>
        <div class='form_text'>$CountryT<span>*</span></div>
        <fieldset class="sender_countryFieldset">
           <input type='text' class="form_field form-control" readonly id="sender_country" name="sender_country" value='$storeCountry' class=''/>
        </fieldset>
        </div><!--form_fill end--> 

        <div class='form_fill'>
         <div class='form_text'>$phoneT<span>*</span></div>
         <input type="text" class="form_field form-control" name="sender_phone" id="sender_phone" value="$uPhone" required />
        </div><!--form_fill end-->     
    ...
    <div class='form1 fadeInUp' id="receiver_area" style='display: none;' >
        ...
        <input type="text" class="form_field form-control" value="$uName" name="receiver_name" id="receiver_name" required="" />
        </div><!--form_fill end-->

        <div class='form_fill'>
         <div class='form_text'>$RemailT<span>*</span></div>
         <input type="email" class="form_field form-control" value="$uEmail" name="receiver_email" id="receiver_email" />
        </div><!--form_fill end-->

        <div class='form_fill'>
         <div class='form_text'>$RaddressT<span>*</span></div>
         <textarea class="form_field form-control" name="receiver_address" id="receiver_address"></textarea>
        </div><!--form_fill end--> 

        <div class='form_fill'>
         <div class='form_text'>$receiverZipCodeT<span>*</span></div>
         <input type="text" class="form_field form-control" name="receiver_post" id="receiver_post" required="" value="$uPost" />
        </div><!--form_fill end--> 

        <div class='form_fill'>
         <div class='form_text'>$RCityT<span>*</span></div>
         <input type="text" class="form_field form-control" name="receiver_city" id="receiver_city" value="$uCity" required />
        </div><!--form_fill end--> 

        <div class='form_fill'>
        <div class='form_text'>$RCountryT<span>*</span></div>
        <fieldset class="sender_countryFieldset">
           <input type='text' class="form_field form-control" readonly id="receiver_country1" name="receiver_country" value='$storeCountry' class=''/>
        </fieldset>
        </div><!--form_fill end--> 

        <div class='form_fill'>
         <div class='form_text'>$RphoneT<span>*</span></div>
         <input type="text" class="form_field form-control" name="receiver_phone" id="receiver_phone" value="$uPhone" required />
        </div><!--form_fill end-->    
    ...
    <div class='button_area fadeInLeft' >
      ...
      <div class='form_text'>
      <a href="page-return-policy" target="_blank">Products return policy</a><span>*</span><br /><br /></div>
