                ...
                <div class="LunchsecondSec">
                    <div class="SndSecInnerdiv">
                        ...
                        <input type="hidden" id="g-contactFormSubmit" name="g-contactFormSubmit">
                            ...
                            <div class="flexdiv">
                                <input type="text" name="form[practice_name]" id="" placeholder="Practice Name" required>
                                <input type="text" name="form[name]" id="" placeholder="Full Name" required>
                            </div>
                            <div class="flexdiv"><b>Multi-Site Practice</b>
                                <div>
                                   <input type="radio" value="Yes" name="form[multi_site_practice]" placeholder="Yes" style="height: 20px;width: 30px; margin:0 10px;">
                                    <b>Yes</b>
                                    <input type="radio" value="No" name="form[multi_site_practice]" placeholder="No" checked style="height: 20px;width: 30px; margin:0 10px;">
                                    <b>No</b>
                                </div>
                            </div>
                            <div class="flexdiv">
                                <input type="email" name="form[email]" id="" placeholder="Email" required >
                                <input type="text" name="form[phone]" id="" placeholder="Contact No" >
                            </div>
