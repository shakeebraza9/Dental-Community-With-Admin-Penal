...
if(!empty($msg)){
    ...
    $return8 = $functions->someDayOfTrial("someDayOfTrial",3);
    $return9 = $functions->someDayOfTrial("someDayOfTrial",5);
    $return10 = $functions->someDayOfTrial("someDayOfTrial",6);
    $return11 = $functions->someDayOfTrial("someDayOfTrial",7);
    $return12 = $functions->notLoggedinTrial("trialNotLoggedinDay",3);
    ...
    $table ='<table border="1">
                ...
                '.$return1.''.$return2.''.$return3.''.$return4.''.$return5.''.$return6.''.$return7.''.$return8.''.$return9.''.$return10.''.$return11.''.$return12.'
            </table>';

    if(!empty($return1) || !empty($return2) || !empty($return3) ||
        !empty($return4) || !empty($return5) || !empty($return6) ||
        !empty($return7) || !empty($return8) || !empty($return9) || !empty($return10) ||
        !empty($return11) || !empty($return12) ){
