...
// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '16' ";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '47'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '48'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '49'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '50'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '51'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '52'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '53'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '54'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '55'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '56'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '57'";


// $sql1 =  "SELECT * FROM `paper` WHERE `paper_id` = '58'";


  
$data1 = $dbF->getRow("SELECT * FROM `paper` WHERE `paper_id` = '16' ");
...
$subject_id           = $data1['subject_id'];
   ...
   $sql2 = "SELECT `subject_title`,`minutes` FROM `subjects` WHERE `subject_id` = '$subject_id'";
...
?>
    ...
    <div class="result_main">
        <div class="result_top">
            ...
            <h2><?php echo date('d-M-Y', strtotime(@$exam_date)); ?></h2>
        </div>
        <!-- result_top -->
       ...
       <?php } ?>
            ...
            <strong>Valid Till
                <?php echo date('d-M-Y', strtotime(@$expiry_date)); ?>.</strong>This is a system generated certificate and does not need any signature or stamp.
            <!-- <hr> -->
        </div>
        <!-- result_bottom -->
    </div>
