...
<div class="index_content mypage">
        <div class="left_right_side">
           ...
           <?php }     $userId     = $_SESSION['webUser']['id'];
...
?>      <div class="jumbo-left">
                    ...
                    <a href="practice-profile">
                       ...
                       <i class="fas fa-cog"></i> Click here to fill Practice Profile 
                    ...
                    <?php } ?>
                        ...
                        <a href="addRating">
                               <i class="fas fa-thumbs-up"></i></i>     Click here to submit your views about coworkers
                            <i class="fas fa-arrow-right" style="margin: 5px;"></i>
                     </a>
                  <?php  }?>
                ...
                <div class="col44">
                    <div id="tabs">
                        <ul>
                            <li><a href="#tabs-1">My Uploads <span><?php echo $functions->countMyUploads() ?></span></a></li>
