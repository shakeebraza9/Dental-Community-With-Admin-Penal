...
<div class="index_content mypage">
    <div class="left_right_side">
        ...
        <div class="left_side">
            <?php
                $active = 'resources'; include'dashboardmenu.php';           
            ?>
        </div><!-- left_side close -->
...
<div class="right_side_top">
                <div class="change-session">
                    ...
                    ?>
                    <div class="col1_btnn">
                        <div data-toggle="tooltip" title="Help Video" style="position: absolute;right: 100%;top: 4px;" class="" onclick="video('Bt_Ue3gSfjE')"><i class="fa fa-question-circle"></i></div>
    ...
    <h3>
        ...
        <div data-toggle="tooltip" title="Help Video" style="margin-left: 10px;top: 20px;" class="help" onclick="video('Y_yht7E7XIk')"><i class="fa fa-question-circle"></i></div>
...
<li><a href="#tabs-11">Appraisal </a></li>
        ...
        <div id="tabs-1" class="staff-profile">
            ...
            <?php if($_SESSION['currentUserType'] != 'Employee'  || $_SESSION['superUser']['hruser'] == 'full') { ?>
                 <!-- <a style="margin: 30px -1px;" onclick="documentInsert_profile_detail()"  ><i class="fas fa-plus"></i>&nbsp;Add Document</a> -->
                  ...
                  <a onclick="documentsadd('Add_Folder','<?php echo $url_user ?>')" class="myevents" ><i class="fas fa-plus"></i>&nbsp;Add Folder</a> 
 ...
 $image = $userData['acc_image'];
            ...
            <div class="name"><?php echo $userData['acc_name'] ?><a href='profile?page=Edit Profile&userId=<?php echo $_GET['user'] ?>' style='margin: auto;padding: 10px;color:#561d94;position: unset;top: unset;/* position: absolute; *//* right: 10px; *//* top: 10px; */'><i class='fas fa-edit' data-toggle='tooltip' title='Edit <?php echo $userData['acc_name']; ?> Profile'></i></a></div>
            <div class="row">
                <div class="col-sm-6">Email : <?php echo $userData['acc_email'] ?></div>
                <div class="col-sm-6">Role : <?php echo $Roleee ?></div>
...
<script>var extraObj=$("#extraupload").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='title' value='' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /><input type='hidden' name='category' value='Training' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' name='c_date' class='datepicker' autocomplete='off' readonly value='' /><b>Expiry Date</b><input class='datepicker' name='e_date' type='text' autocomplete='off' readonly /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#extrabutton").click((function(){console.log("startUpload");extraObj.startUpload()}));</script>
                   ...
                   $checked="checked"; 
                    ...
                    foreach ($data as $val) {
                     if($val['files_id']==$value['id']){
                      ...
                      $grey="color: #ccc;";
                      $button='<a href="" id="'.$user.":documents:".$value['id'].'" onclick="changeUserDoc(this.id)" data-toggle="tooltip" title="Undelete Document"><i class="fas fa-eye" style="font-size:20px"></i></a>';
                     }
                    }
...

 {
    ...
    echo"                        <a data-toggle='tooltip' title='Delete' class='delete' type='button' onclick='return confirm(\"Are you sure you want to delete All Document?\");' href='profile-detail?user=$user&alldocumentidPD=$id' style='top: 9px; $style'><i class='fa fa-times' aria-hidden='true'></i>
     ...
     if($value['file'] !='#'){echo "<a $anchor><i class='far fa-file-alt' style='$grey'></i></a>";}
                    ...
                    else{echo "<a ><i class='far fa-file-alt' style='$grey'></i></a>";}
...
if($_SESSION['currentUserType'] == 'Master' || $_SESSION['currentUserType'] == 'Practice' ){
                      echo " <a data-toggle='tooltip' title='Delete All' class='delete' type='button' onclick='return confirm(\"Are you sure you want to delete All Document?\");' href='profile-detail?user=$user&alldocumentidPD=$tid' style='top: 83px;'><i class='fa fa-times' aria-hidden='true'></i>
                                  </a>";
      } 
      if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hruser'] == 'full') 
...
<script>
var extraObjRecruitment=$("#extrauploadRecruitment").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='title' value='' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /><input type='hidden' name='category' value='Recruitment' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' class='datepicker' autocomplete='off' readonly name='c_date' value='' /><b>Expiry Date</b><input type='text' name='e_date' value='' class='datepicker' autocomplete='off' readonly /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#extrabuttonRecruitment").click((function(){
...
<!--<script>-->
<!--var extraObjtabs=$("#extrauploadtabs-4").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='title' value='' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /><input type='hidden' name='category' value='Signed Policies' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' name='c_date' class='datepicker' autocomplete='off' readonly value='' /><b>Expiry Date</b><input type='text' name='e_date' value='' class='datepicker' autocomplete='off' readonly /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#extrabuttontabs-4").click((function(){-->
...
<!--<script>-->
<!--var mmObj=$("#mmupload").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='category' value='Minute Meeting' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' name='c_date' class='datepicker' autocomplete='off' readonly value='' /><b>Expiry Date</b><input type='text' name='e_date' class='datepicker' autocomplete='off' readonly value='' /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#mmbutton").click((function(){-->
...
<!--<script>-->
<!--var mHRAObj=$("#mHRAupload").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='category' value='MHRA' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' class='datepicker' name='c_date' autocomplete='off' readonly value='' /><b>Expiry Date</b><input type='text' class='datepicker' name='e_date' autocomplete='off' readonly value='' /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#mHRAbutton").click((function(){-->
...
<script>
var extraObjad=$("#extrauploadad").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='title' value='' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='category' value='Additional Document' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' name='c_date' class='datepicker' autocomplete='off' readonly value='' /><b>Expiry Date</b><input type='text' name='e_date' value='' class='datepicker' autocomplete='off' readonly /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#extrabuttonad").click((function(){
...
<script>
var pfObj=$("#pfupload").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='category' value='Private Folder' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' name='c_date' class='datepicker' autocomplete='off' readonly value='' /><b>Expiry Date</b><input type='text' class='datepicker' autocomplete='off' readonly name='e_date' value='' /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#pfbutton").click((function(){
...
<!--<script>-->
<!--var mmObj=$("#onbupload").uploadFile({url:"profile-detail",dragDrop:!0,fileName:"document",dragDropStr: "<span><b>Drop files here</b></span>",allowedTypes:"jpg,jpeg,bmp,gif,png,img,txt,pdf,psd,docx,doc,pptx,ppt,xlsx,xlr,xls,csv,pps,zip,gzip,rar,gz,tar,tar.gz,ios,max,dwg,eps,ai,torrent,html,css,js,xml,xhtml,rss,mp4,m4a,mp3,mpg3,3gp,flv,wmv,wav,mqv,mpeg4,swf,mov,mpg,avi,raw,wmv,rm,obj,odt,fodt,ods,fods,odp,fodp,odg,fodg,odf",extraHTML:function(){return"<div><input type='hidden' name='category' value='Minute Meeting' /><input type='hidden' name='submit' value='submit' /><input type='hidden' name='documentInsert_profile_details' value='documentInsert_profile_details' /><input type='hidden' name='user' value='<?php echo $uUUID ?>' /> <br/><b>Sub Category</b><select name='sub_category'><?php echo $allsubOptions; ?><option value=''>other</option></select><b>Completion Date</b><input type='text' name='c_date' class='datepicker' autocomplete='off' readonly value='' /><b>Expiry Date</b><input type='text' name='e_date' class='datepicker' autocomplete='off' readonly value='' /><b>Details</b><input type='text' name='desc' value='' /></div>"},autoSubmit:!1});$("#onbbutton").click((function(){-->
...
<div class="form-group col-12 col-sm-6" style=""><label>Date Appraisal Carried out</label>
 <input class="datepickerr form1Input" id="dateField" type="text" placeholder="Select one"  name="appraisal_date"  autocomplete="off" readonly onchange="$('#date_err').hide();" style="width: 99%;">
...
<div id="tabs-add1" style='width:100%;'>
    <div class="tabImage">
        <img src="<?php echo WEB_URL; ?>/webImages/appraisal1.webp">
    </div>
...
<div class="form-group col-12 col-sm-6" style=""><label>Date Appraisal Carried out</label>
 <input class="datepickerr form2Input"  type="text" placeholder="Select one"  name="appraisal_date"  autocomplete="off" readonly onchange="$('#date_err').hide();" style="width: 99%;">
 <i class="fa fa-calendar" aria-hidden="true" style=" margin-left: -27px;"></i>
 <div id="date_err" style="color:red;display: none;">field is empty</div>
</div>
<div class="form-group col-12 col-sm-6" style="">
