...
<div class="index_content mypage">
    <div class="left_right_side">
        ...
        <div class="right_side hrm">
            ...
            <div class="right_side_top">
                ...
                if($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0'){
                    ...
                    $sql = "SELECT * FROM `record` WHERE `userId`='$user' AND `hour` !='0' AND `date` >= DATE_SUB(CURDATE(),INTERVAL 30 DAY)";
                    ...
                    <div class="col-md-4">
                        <div class="cpd-inner-box">
                            <div class="cpd-box-content">
                                ...
                                <h3><span>
                                        <?php echo "<b>".$functions->documentsCount('Training')."</b> (Training)<br><b>".$functions->documentsCount('Recruitment')."</b> (Recruitment)<br><b>".$functions->documentsCount('Signed Policies')?></b> (Signed Policies)</span></h3>
                             <h5>Your Pending Documents</h5>
                            </div>
                            <img src='webImages/hr-d.svg'>
                            <div class="line"></div>
                        </div>
                        <!-- cpd-inner-box -->
                    </div>
        ...
        <button style='display: inline-block; max-width: 192px;'class='submit_class' onclick='lieuform()'>Overtime Request Form</button>&nbsp;&nbsp;
        
           <button <?php echo $display; ?>   class='submit_class' onclick='employeeleaveform()'> Holiday Form</button>
          <button  <?php echo $displayblock; ?>  class='submit_class' onclick='leaves()'>Leave Request Form</button>&nbsp;&nbsp;

            <button <?php echo $display;?> style='display: inline-block;' class='submit_class' onclick='window.open("rotaStatus")'>Rota Status</button>&nbsp;&nbsp;
             <a href="<?php echo WEB_URL; ?>/holiday-entitlement-calculator"  data-toggle='tooltip' title='Holiday Entitlement Calculate' style="float: right;font-size: 30px;width: 57px;margin-top: 18px; color: #561d94;"> <i class="fas fa-calculator"></i> </a>
