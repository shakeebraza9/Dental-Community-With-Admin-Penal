                       ...
                       if ($chekFile > 0) {
                          ...
                          $hide = "  <a class='anim anim2 tooltips' data-toggle='tooltip' title='Click to Upload Staff Folder' $display href='javascript:;'  onclick='documentselectcpdpdf($thisid,$certificate_user);' ><i class='fa fa-address-card'></i> </a>";
                            ...
                            echo "<tr>
                                    ...
                                    <td>";
                                     if ($result == 'Expired' || $status == 'expired') {  echo  "<a class='anim anim2 ' data-toggle='tooltip' title='Click To Print' $display href='printResult.php?assignid=$assignid'><i class='fas fa-print'></i> </a>
                              <a class='anim anim2 ' data-toggle='tooltip' title='Click To Download' $display href='downloadResult.php?assignid=$assignid'><i class='fas fa-download'></i></a>
                              

<a href='javascript:;' data-id='$value[assign_id]'  onclick='AjaxDelScript(this);'  $faileddisplay class='delete'>Delete</a>
                              "; }
                                   else{
                                         echo  "<a class='anim anim2 ' data-toggle='tooltip' title='Click To Print' target='_blank' $display href='printResult.php?assignid=$assignid'><i class='fas fa-print'></i> </a>
                              <a class='anim anim2 ' data-toggle='tooltip' title='Click To Download' $display href='downloadResult.php?assignid=$assignid'><i class='fas fa-download'></i></a>
                              $hide
