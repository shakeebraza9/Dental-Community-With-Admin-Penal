...

 {
    ...
    echo"                        <a data-toggle='tooltip' title='Delete' class='delete' type='button' onclick='return confirm(\"Are you sure you want to delete All Document?\");' href='practice-training?user=$user&alldocumentidPD=$id' style='top: 9px;'><i class='fa fa-times' style='margin-top: 7px;' aria-hidden='true'></i>
                    ...
                    echo "<div class='dtitle'>$value[title]</div>
                         <div class='col1_btnn col1_btn22' style='    height: auto;
    line-height: 1;
    padding: 10px 20px;
    width: auto;
    border-radius: 30px;
    margin-left: 0;
                        ...
                        <a data-toggle='tooltip' title='View' id='$value[id]&user=$user' href='javascript:;' onclick='documentInsert(this.id)'>View</a>
                          </div>
                        </div>";
...
if($value['file'] !='#'){echo "<a $anchor><i class='far fa-file-alt'></i></a>";}
    ...
    border-radius: 30px;
    margin-left: 0;'>
                    <a id='$value[title_id]&user=$user&uid=$value[id]' href='javascript:;' onclick='documentView(this.id)'>View Again</a>
                </div>
                        </div>";
                }
            ?>
