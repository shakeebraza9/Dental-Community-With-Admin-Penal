...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Edit Expiry Date"  class="ablue" id="' . $value['qty_pk'] . '" onclick="editexpiryDate(this.id)"> ('.$value['expiryDate'].')</a>';
...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Add Expiry Date" class="ablue" id="' . $value['qty_pk'] . '" onclick="editexpiryDate(this.id)"> Add Expiry Date</a>';
}
}
...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Add / Deduct Quantity"  class="ablue" id="' . $value['qty_pk'] . '" onclick="addDeductQty(this.id)">'.$value['qty_item'].'</a>';
...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Edit location"  class="ablue" id="' . $value['qty_pk'] . '" onclick="editStockLocation(this.id)">'.$value['location'].'</a>';
}
...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Add location" class="ablue" id="' . $value['qty_pk'] . '" onclick="editStockLocation(this.id)">Add Location</a>';
}}
?>
...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Edit Min Stock Quantity"  class="ablue" id="' . $value['qty_pk'] . '" onclick="editStockmin_stock(this.id)">'.$value['min_stock'].'</a>';
...
{ 
     ...
     echo '<a data-toggle="tooltip" title="Add product to basket" id="' . $value['qty_product_id'].":".$value['qty_product_scale'].":".$value['qty_product_color'] . '" class="ablue" onclick="addTobasket(this.id)"><i class="fas fa-cart-plus"></i></a>';
