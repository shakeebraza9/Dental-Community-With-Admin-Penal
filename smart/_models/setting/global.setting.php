...
define("DB_HOST", 'localhost');
define("DB_USER", 'doxu10vne1mw_portal_2022');
define("DB_PASS", '1UF}R[NbYL20');
define("DB_NAME", 'doxu10vne1mw_portal_2022'); //  using in pdo
define("DB_TYPE", 'mysql');
...
define("PROJECT_ID", '174');
define("PROJECT_NAME", 'Smart Dental Compliance'); // on any Illegal activity send this name
...
trait global_setting
{
       ...
       public $domainName   = 'Smart Dental Compliance'; //Example IBMS OR imedia
       public $domain       = 'smartdentalcompliance.com';  // Example.com OR imedia.com no www ibms.com Dont use sub domain
       public $webName      = 'Smart Dental Compliance';  // Example Here IBMS Management OR Interactive Media using for replace name, Also use in Email {{WebName}} Or aorg
       public $defaultEmail = "smartdentalcompliance.com";  //Only domain name ibms.com,, OR imedia.com
       public $bounceEmail  = "b@smartdentalcompliance.com";  //Only use in cron
       ...
       public $bounceWebEmail  = "webmaster@smartdentalcompliance.com";  //if $isCheckBounceWebMails is ture, then this workds. // on $bounceWebEmail email all fail mails report send...
