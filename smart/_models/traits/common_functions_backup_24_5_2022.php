...
//push
public function push_notification($title, $message, $player_id, $url = "https://smartdentalcompliance.com",$debug=false)
{
...
$sql = "SELECT `player_id`,`acc_id` FROM `accounts_user` WHERE `player_id` LIKE '%$playerId%'";
...
$arry = implode(",", $arry);
$sql = "UPDATE `accounts_user` SET `player_id` = '$arry' WHERE `accounts_user`.`acc_id` = '$user'";
$this->dbF->setRow($sql);
}

public function getUserPlayerId($user)
{
$sql = "SELECT `player_id` FROM `accounts_user` WHERE `acc_id` = '$user' AND  `acc_id` NOT IN (SELECT `acc_id` FROM `accounts_user` WHERE `acc_type`='0') ";
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user'";
$data = $this->dbF->getRow($sql);
...
$sql2 = "SELECT `userevent`.`id`,`userevent`.`due_date`,`title`,`category`,`type`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE())";
...
$user = intval($_SESSION['currentUser']);
$sql = "SELECT * FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='$a' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";


$sql2 = "SELECT `userevent`.`id`,`userevent`.`due_date`,`title`,`category`,`type`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='$a'";
...
$sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE())";
...
$user = intval($_SESSION['currentUser']);
$sql = "SELECT DISTINCT(`category`) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='$a' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";



$sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='$a'";

// ============================================//
// $sql = "SELECT DISTINCT(`category`) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `publish` = '1' AND `due_date`<=(SELECT CURDATE()) AND id NOT IN(SELECT title_id FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved` IN ('1','0','-1') AND `user`='$user')  AND id NOT IN (SELECT recurrence FROM eventmanagement)";

// $sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`<=(SELECT CURDATE())";
$data = $this->dbF->getRows($sql);
$data2 = $this->dbF->getRows($sql2);
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `type`='mandatory' AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user' AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `type`='recommended' AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user' AND `type`='recommended'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='mandatory' AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='mandatory' AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user' AND ((`userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH))  OR `userevent`.`due_date` IS NULL) AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='mandatory' AND `due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE  `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='mandatory' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='mandatory' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user' AND (`userevent`.`due_date` <= (SELECT CURDATE()) OR `userevent`.`due_date` IS NULL)  AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='recommended' AND `due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type`='recommended'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='recommended' AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type`='recommended'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='recommended' AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user' AND ((`userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH))  OR `userevent`.`due_date` IS NULL) AND `type`='recommended'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='recommended' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='recommended'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='recommended' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `user`='$user' AND (`userevent`.`due_date` <= (SELECT CURDATE()) OR `userevent`.`due_date` IS NULL) AND `type`='recommended'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `type`='mandatory' AND `approved`='1' AND `user`='$user'";
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
{
$sql = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `type`='recommended' AND `approved`='1' AND `user`='$user'";
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `type`='mandatory' AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved` != '1' AND `user`='$user' AND `type`='mandatory'";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
$sql2 = "SELECT COUNT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`>(SELECT CURDATE())";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
return $data[0] + $data2[0] + 0;
}
...
$sql1 = "SELECT DISTINCT(`sub_dcategory`) FROM `documents` WHERE `category`='$Training' AND `assignto` IN ('all','$usertmp','all:$_SESSION[currentUser]')  AND `sub_dcategory` !=''";

$sql2 = "SELECT DISTINCT(`sub_dcategory`) FROM `userdocuments` WHERE `category`='$Training' AND `user` = '$usertmp' AND `sub_dcategory` !=''";
...
$data = $this->dbF->getRows("SELECT * FROM `documents` WHERE `assignto` IN ('all','$user','all:$pid') AND `category`='$category'"); 
foreach ($data as $key => $value) {


$this->dbF->getRow("SELECT * FROM `userdocuments` WHERE `user`= ?  AND `category`='$category'  AND `title_id`='$value[id]'",array($user));
...
$ttl = 0;
$ttlDone = 0;
$data = $this->dbF->getRows("SELECT id FROM `documents` WHERE `assignto` IN ('all','$user','all:$pid') order by id"); 
foreach ($data as $key => $value) {
...
$user = intval($_SESSION['currentUser']);
$sql = "SELECT DISTINCT(`sub_dcategory`) FROM `userdocuments` WHERE `category`='$Training' AND `assignto` IN ('all','$user','all:$user') ";
$data = $this->dbF->getRows($sql);
...
$sql = "SELECT  DISTINCT(`category`) FROM `eventmanagement` JOIN `userevent` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `userevent`.`assignto` IN ('-1.$d[0]','$user')";
$data = $this->dbF->getRows($sql);
...
$user = intval($_SESSION['currentUser']);
$sql = "SELECT  DISTINCT(`category`) FROM `eventmanagement` JOIN `userevent` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND (`userevent`.`assignto` > '0' OR `userevent`.`assignto` = '-1.$user') AND `user`='$user'";
$data = $this->dbF->getRows($sql);
usort($data, 'compare_category');
$cate = "<h5 class='all atv'>All</h5>";
foreach ($data as $key => $value) {
...
$d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$user'");
$sql = "SELECT  COUNT(`category`) FROM `eventmanagement` JOIN `userevent` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `userevent`.`assignto` IN ('-1.$d[0]','$user')";
$data = $this->dbF->getRow($sql);
} else {
$user = $_SESSION['currentUser'];
$sql = "SELECT  COUNT(`category`) FROM `eventmanagement` JOIN `userevent` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND (`userevent`.`assignto` > '0' OR `userevent`.`assignto` = '-1.$user') AND `user`='$user'";
$data = $this->dbF->getRow($sql);
}
return $data[0] + 0;
}
...
$user = intval($_SESSION['superid']);
$d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$user'");
$sql = "SELECT `userevent`.`id`,`title`,`category`,`type`,`userevent`.`due_date`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `userevent`.`assignto` IN ('-1.$d[0]','$user') ORDER BY `title`";
$data = $this->dbF->getRows($sql);
} else {
$user = intval($_SESSION['currentUser']);
$sql = "SELECT `userevent`.`id`,`userevent`.`color_publish`,`title`,`category`,`type`,`userevent`.`due_date`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND (`userevent`.`assignto` > '0' OR `userevent`.`assignto` = '-1.$user') AND `user`='$user' ORDER BY `title`";
$data = $this->dbF->getRows($sql);
}
...
$user = intval($_SESSION['superid']);
$d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$user'");
$sql = "SELECT  DISTINCT(`category`) FROM `eventmanagement` JOIN `userevent` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='1' AND `userevent`.`assignto` IN ('-1.$d[0]','$user')";
$data = $this->dbF->getRows($sql);
usort($data, 'compare_category');
$cate = "<h5 class='all atv'>All</h5>";
foreach ($data as $key => $value) {
...
$user = $_SESSION['superid'];
$d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$user'");
$sql = "SELECT  COUNT(`category`) FROM `eventmanagement` JOIN `userevent` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='1' AND `userevent`.`assignto` IN ('-1.$d[0]','$user') AND (      
...
(  `eventmanagement`.`recurring_duration` = '1 week' AND  `userevent`.`due_date` >= DATE_SUB(CURDATE(),INTERVAL 7 DAY)) OR 
...
$user = intval($_SESSION['superid']);
$d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$user'");
$sql = "SELECT `userevent`.`id`,`userevent`.`file` as fl,`userevent`.`dateTime` as `dt`,`userevent`.`due_date` as `dd`,`title`,`category`,`type` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='1' AND `userevent`.`assignto` IN ('-1.$d[0]','$user')AND 
...
<a href="<?php echo WEB_URL ?>/action-plan" class="submit_class" style="padding: 10px 10px;max-width: max-content;">Show Pending Action Plan</a>
...
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['ccalendar'] == '0') {
    echo   $user = intval($_SESSION['superid']);
    $d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$user'");
...
{ ?>
<div>
<a href="<?php echo WEB_URL ?>/action-plan_completed" class="submit_class" style="padding: 10px 10px;max-width: max-content;">Show Completed Action Plan</a>
<ul style="text-align: initial;">
<li style="display: none;"></li>
<h3 style="margin-left: 34%">Action Plan Pending</h3>
</ul>
<div>
<table class="table table-hover dTable tableIBMS dataTable">
<thead>
...
if ($page == 'editevent') {
// if ($value['dateTime'] == '') {
$li .= ' <span>(' . date("d-M-Y", strtotime($value['due_date'])) . ')</span>';
// } else {
...
} else if ($value['approved'] == '-1' && $value['assignto'] > 0 || strpos($value['assignto'], '-1') !== false && $_SESSION['currentUserType'] != 'Employee') {
...
$sql1 = "SELECT  COUNT(*) FROM `myevents` WHERE (`assignto` IN ('-1.$d[0]','$user')  OR  `user`='$user' ) AND `status`!='deleted' ORDER BY `title`";
...
$sql = "SELECT  COUNT(*) FROM `myevents` WHERE `user`='$user1' AND `status`!='deleted'";
$data = $this->dbF->getRow($sql);
$return = $data[0] + 0;
}
...
$sql = "SELECT  * FROM `myevents` WHERE (`assignto` IN ('-1.$d[0]','$user')  OR  `user`='$user' ) AND `status`!='deleted' ORDER BY `title` , `dateTime` DESC";
$data = $this->dbF->getRows($sql);
...
$li .= '<li  ' . $style . ' class="all blue ' . $complete . ' ' . str_replace('&', '', str_replace(' ', '', $value['category'])) . '">
<div class="col4_main_left1">
' . $value['title'] . '
...
$user = intval($_SESSION['webUser']['id']);
$sql = "SELECT  * FROM `myevents` WHERE `user`='$user1' AND `status`!='deleted' ORDER BY `title` , `dateTime` DESC";
$data = $this->dbF->getRows($sql);
$li = "";
$catName = "";
...
$li .= '<a class="ablue" onclick="myevents(this.id)" id="' . $value['id'] . '" data-toggle="tooltip" title="Edit Event"><i class="fas fa-edit"></i></a>';



$li .= '<a class="ablue 1" onclick="submitMYevent(this.id)" id="' . $value['id'] . '" data-toggle="tooltip" title="Submit Event"><i class="fas fa-file"></i></a>';
...
$recurring_duration = Date('Y-m-d', strtotime($date . '+' . $data['recurring_duration']));
        ...
        $sql      =   "INSERT INTO `myevents`(`user`,`title`,`assignto`,`due_date`,`fetch_id`,`category`,`desc`,`status`,`file`,`recurring_duration`,`comment`,`actionplan`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        $array   = array($user, $title, $assignto, $recurring_duration,$fetch_id, $dataX['category'], $dataX['desc'], "pending", "#", $recurring, $comment, $actionplan);
        $this->dbF->setRow($sql, $array, false);
        if ($_SESSION['currentUserType'] == 'Employee') {
            $uid = $_SESSION['webUser']['id'];
        } else {
...
if (strpos($assignto, '-1') !== false) {
    ...
    foreach ($d as $key => $value) {
        $this->notifications('uevent', $value['id_user']);
    }
} else {
...
$this->db->beginTransaction();
 ...
 $sql    =   "UPDATE `myevents` SET
         ...
         WHERE   `id` = '$id'";
$array  = array($title, $date, $docname, $assignto, $category, nl2br($desc1), $status, $approved, $recurring_duration, $color_publish);
$this->dbF->setRow($sql, $array, false);
...
// $this->setlog("My Event Update", $this->UserName($user) . " : " . $user, "", $title . " : " . $id);
return true;
} else {
return false;
}
...
$sql = "SELECT `acc_id` FROM `accounts_user` WHERE `acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$id' AND `setting_name`='account_under' AND `id_user` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val` IN ('Dentist','Dental Hygienist and Dental Therapist'))) $var AND acc_type='1'";
$data = $this->dbF->getRows($sql);
$op = "";
foreach ($data as $key => $value) {
...
// return true;
// @$id = $_GET['id'];
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superid']['ccalendar'] == '0') {
$user = $_SESSION['superid'];
} else {
$user = $_SESSION['currentUser'];
}
...
{
$sql = "SELECT title FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT title FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH)";
$data = $this->dbF->getRows($sql);
$data2 = $this->dbF->getRows($sql2);
$mysql = array_merge($data, $data2);
$mysql = array_unique($mysql, SORT_REGULAR);
...
{
$sql = "SELECT title FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`)";
$sql2 = "SELECT title FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved`='-1' AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE())";
$data = $this->dbF->getRows($sql);
$data2 = $this->dbF->getRows($sql2);
$mysql = array_merge($data, $data2);
$mysql = array_unique($mysql, SORT_REGULAR);
...
$sql  = "SELECT * FROM filesmanager WHERE publish='1' AND `dateTime`>$date ORDER BY ID DESC";
$data =  $this->dbF->getRows($sql);
$cate = "<div style='width:95%;margin:auto;'>";
foreach ($data as $key => $value) {
...
$data = $this->dbF->getRow($sql,array($id));
return $data['recurring_duration'];
}
...
public function isholidayShow($user)
{
echo '   <table class="table table-hover dTable tableIBMS dataTable">
<thead>
<tr>
<th>sno</th>
<th>Practice Name</th>
...
public function redoEvent()
{

if (isset($_POST['edit'])) {
if (!$this->getFormToken('redoEvent')) {
return false;
}
...
$sql      =   "UPDATE `userevent` SET `file` = ? ,`assignto` = ? ,`desc` = ? ,`comment` = ? , `color_publish` = ? ,`dateTime` = ? WHERE `id` = ?";
$array   = array($docname, $assignto,  nl2br($desc), $comment, $color_publish, $date, $edit_id);
$this->dbF->setRow($sql, $array, false);
if ($approved == 1) {
...
$mysql = "DELETE FROM `usereventForms` WHERE `ue_id`='$edit_id'";
$this->dbF->setRow($mysql);
...
$old_file   =  $value['file'];
$title      = $this->eventTitle($title_id);
$d = $this->dbF->getRow("SELECT `recurring_duration` FROM `eventmanagement` WHERE `id`='$title_id'");
...
return  json_encode($mysql);
}
public function calendarEvents111()
{
$j = '';
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['ccalendar'] == '0') {
$user = $_SESSION['superid'];
...
{
$sql = "SELECT * from `practiceprofile` WHERE `user_id` = '$id' AND `practice_name` != '' AND `practice_address` != '' AND `telephone` != '' AND `staff` != '' AND `information` != '' AND `surgeries` != '' AND `room` != '' AND `autoclave` != '' AND `disinfectors` != '' AND `ultrasonic` != '' AND `compressor` != '' AND `npm` != '' AND `sedation` != '' AND `domiciliary` != ''";
$data = $this->dbF->getRow($sql);
if (empty($data[0])) {
return true;
} else {
...
// $user = intval($_SESSION['currentUser']);
// }
$sql = "SELECT DISTINCT(`userService`) FROM `clientAddTbl`  WHERE loginid = '$_SESSION[currentUser]'";
...
if (isset($_POST['submit'])) {
if (!$this->getFormToken('addReminder')) {
return false;
}
...
$sql = "UPDATE `clientAddTbl` SET `cs` = '$cs', `sort` = '$maxSort' WHERE `clientAddTbl`.`id` = '$refId'";
$this->dbF->setRow($sql);
...
$sql = "UPDATE `clientAddTbl` SET  `sort` = '$maxSort' WHERE `clientAddTbl`.`id` = '$refId'";
$this->dbF->setRow($sql);
...
$q = "SELECT heading FROM clientCreateNotes WHERE heading='$title' AND id='$refId'";
$this->dbF->getRow($q);
if ($this->dbF->rowCount == 0) {
...
$sql = "UPDATE `clientAddTbl` SET  `sort` = '$maxSort' WHERE `clientAddTbl`.`id` = '$mainId'";
$this->dbF->setRow($sql);




$sql = "UPDATE `clientCreateNotes` SET `heading` = '$title' WHERE `clientCreateNotes`.`id` = '$refId'";
$this->dbF->setRow($sql);
...
// htmlspecialchars($sub_dcategory); 
            ...
            try {
                ...
                $sql      =   "INSERT INTO `myuploads`(`title`,`file`,`category`,`sub_category`,`user`,publish) VALUES (?,?,?,?,?,?)";
                $array   = array($title, $filename, $category, $sub_category, $user, '1');
                $this->dbF->setRow($sql, $array, false);
  $lastId = $this->dbF->rowLastId;
      ...
      $this->setlog("MyUploads Add", $this->UserName($user) . " : " . $user, $lastId, $title);
                ...
                if ($dchk == '1') {
                    $sql = "INSERT INTO `documents`(`title`, `file`,`assignto`,`category`,`sub_dcategory`,`publish`,`ytcode`)
                                    VALUES (?,?,?,?,?,?,?)";
                    $array   = array($title, $filename, $userId, $dcategory, $sub_dcategory, '1', $ytcode);
                    $this->dbF->setRow($sql, $array, false);
                      $lastId = $this->dbF->rowLastId;
...
<div class='main-row-down'>";
 ...
 $html = <<<HTML
<div  id='mulitplefileuploader{$autoId}'></div>
...
if ($this->dbF->rowCount == 1) {
    foreach ($data_s as $key_s => $value_s) {
        ...
        echo '<li class="' . (($value_s['type'] == 'mandatory') ? 'red' : '') . '">
<div class="row-title">
...
<li class="' . (($value_s['type'] == 'mandatory') ? 'red' : '') . '">
<div class="row-title">
' . str_replace(array('Update ', 'Review ', 'Complete ', 'Carry Out ', 'Upload ', ' Due'), '', $title) . '<span> (' . date('d-M-Y', strtotime($value_s['due_date'])) . ')</span>
</div>
...
public function submitrecruitment()
{
if (isset($_POST['submit'])) {
...
if (!$this->getFormToken('recruitment')) {
return false;
}
...
$this->dbF->setRow("DELETE FROM `documents` WHERE `title`='$data[title]' AND `file`='$data[file]'");
// $lastId = $this->dbF->rowLastId;
if ($_SESSION['currentUserType'] == 'Employee') {
$user = $_SESSION['superid'];
} else {
...
$sql2  = "DELETE FROM `recruitment` WHERE id='$id'";
$this->dbF->setRow($sql2);
if ($this->dbF->rowCount) {
///    @unlink($name);
// ========================TrashData=============================================
...
<div class="col4_main_left1">
' . $value['title'] . '
<span data-toggle="tooltip" title="Update Date: ' . date("d-M-Y", strtotime($value['dateTime'])) . '">(' . date("d-M-Y", strtotime($value['dateTime'])) . ')</span>
</div><!-- col4_main_left1 close -->
<div class="col4_main_left3">';
$link = explode(",", $value['file']);
$allowed = array('gif', 'png', 'jpg', 'tiff', 'jpeg', 'bmp', 'webp', 'JPG', 'PNG', 'GIF', 'WEBP', 'TIFF', 'BMP', 'JPEG', 'pdf', 'PDF');
...
$user = intval($_SESSION['superid']);
$sql = "SELECT COUNT(*) FROM `userdocuments` WHERE (`expiry_date` > DATE_SUB(CURDATE(), INTERVAL 1 MONTH) OR `expiry_date` IS NULL) AND `user`='$user' AND `category`='$category'";
} else {
$user = intval($_SESSION['currentUser']);
$sql = "SELECT COUNT(*) FROM `userdocuments` WHERE (`expiry_date` > DATE_SUB(CURDATE(), INTERVAL 1 MONTH) OR `expiry_date` IS NULL) AND `user` IN (SELECT `acc_id` FROM `accounts_user` WHERE `acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user' AND `setting_name`='account_under') AND `acc_type`='1') AND `category`='$category'";
}
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
$sql1 = "SELECT `file`,`title`,`sub_category`,`category` FROM `documents` WHERE `id`= ?";
$data =  $this->dbF->getRow($sql1,array($id));
// $path = $data['file'];
// $path = parse_url($data['file'], PHP_URL_PATH);
// $name = $_SERVER['DOCUMENT_ROOT'] . $path;
...
// @unlink($name);
// ========================TrashData=============================================
$ds = "delete documents File (Title :" . $data['title'] . ") (category :" . $data['category'] . " ) (sub category is " . $data['sub_category'] . " ) ";
$this->TrashData('HR Files', $ds, $data['file'], $userFrom, $data['assignto'], 'documents', $id, 'deleteDocumentall',$smartQuery);
// ========================TrashData=============================================

$inIDZ = $this->allINID();
$sql2 = "SELECT * FROM `userdocuments` WHERE `title_id`='$id' and user IN ($inIDZ)";
$data2 =  $this->dbF->getRows($sql2);
...
$tDESC = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " )(file is " . $val['file'] . " ) ";
...
// @unlink($name);
// ========================TrashData=============================================
$ds = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " ) ";
...
$tDESC = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " )(file is " . $val['file0'] . " ) ";
$this->setlog("HR Files deleteDocumentall", $this->UserName($_SESSION['currentUser']) . " : " . $_SESSION['currentUser'],$val['id'], $tDESC);
...
///  @unlink($name0);
// ========================TrashData=============================================
$ds = "All Document Delete file0 (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " ) ";
...
$tDESC = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " )(file is " . $val['file1'] . " ) ";
$this->setlog("HR Files deleteDocumentall", $this->UserName($_SESSION['currentUser']) . " : " . $_SESSION['currentUser'],$val['id'], $tDESC);
...
// @unlink($name1);
// ========================TrashData=============================================
$ds = "All Document Delete file1 (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " ) ";
...
$tDESC = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " )(file is " . $val['file2'] . " ) ";
$this->setlog("HR Files deleteDocumentall", $this->UserName($_SESSION['currentUser']) . " : " . $_SESSION['currentUser'],$val['id'], $tDESC);


// @unlink($name2);
// ========================TrashData=============================================
$ds = "All Document Delete file2 (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " ) ";
...
$tDESC = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " )(file is " . $val['file3'] . " ) ";
$this->setlog("HR Files deleteDocumentall", $this->UserName($_SESSION['currentUser']) . " : " . $_SESSION['currentUser'],$val['id'], $tDESC);
...
// @unlink($name3);
// ========================TrashData=============================================
$ds = "All Document Delete file3 (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " ) ";
...
$tDESC = "All Document Delete file (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " )(file is " . $val['file4'] . " ) ";
$this->setlog("HR Files deleteDocumentall", $this->UserName($_SESSION['currentUser']) . " : " . $_SESSION['currentUser'],$val['id'], $tDESC);
...
// @unlink($name4);
// ========================TrashData=============================================
$ds = "All Document Delete file4 (Title :" . $val['title'] . ") (category :" . $val['category'] . " ) (sub category is " . $val['sub_category'] . " ) ";
...
$sql2  = "DELETE FROM `userdocuments` WHERE  title_id = '$id' and user IN ($inIDZ)";
$data2 = $this->dbF->setRow($sql2);
...
public function insertRoomsEDIT()
{

if (isset($_POST['submit'])) {
if (!$this->getFormToken('insertRoomsEDIT')) {
return false;
}
...
public function practiceProfile()
{

if (isset($_POST['submit'])) {

if (!$this->getFormToken('practiceProfile')) {
return false;
}
...
$this->db->beginTransaction();
 ...
 $this->dbF->setRow("INSERT INTO `insertRooms`(`loginid`,`practiceID`,`name`,`color`,`desc`) VALUES('$loginid','$practiceID','$add_room_name','$changeColor','$add_room_desc')");
...
$this->db->beginTransaction();
 ...
 $this->dbF->setRow("INSERT INTO `insertDirectory`(`loginid`,`practiceID`,`name`,`phone`) VALUES('$loginid','$practiceID','$add_directory_name','$add_directory_contact')");
...
{
if (isset($_POST['submit'])) {
if (!$this->getFormToken('newBookingForm')) {
return false;
}
$desc        = empty($_POST['desc'])            ? ""    : $_POST['desc'];
...
<div class='col-lg-2'>
<li class='ho' style='background-color: #f2701d;height: auto;padding: 5px;margin-bottom: 5px; width: 31%;display: inline-block;font-size: 15px;font-weight: bold;'>
    <input type='hidden' value='ho' class='ho'><p>Holiday</p>
</li>
<li class='dyo' style='background-color: #f2701d;height: auto;padding: 5px;margin-bottom: 5px;  width: 31%;display: inline-block;font-size: 15px;font-weight: bold;'>
    <input type='hidden' value='do' class='dyo'><p>Day off</p>
</li>
<li class='sk' style='background-color: #f2701d;height: auto;padding: 5px;margin-bottom: 5px;  width: 19%;display: inline-block;font-size: 15px;font-weight: bold;'>
    <input type='hidden' value='sk' class='sk'><p>Sick</p>
</li>
 <li class='sk' style='background-color: #f2701d;height: auto;padding: 5px;margin-bottom: 5px;  width: 13%;display: inline-block;font-size: 15px;font-weight: bold;'>
...
$id     =   base64_decode($id);
$sql    =   "SELECT * FROM record where `date` = '$id' ";
$data   =   $this->dbF->getRows($sql);
}
...
$form_fields[]  = array(
'type'      => 'none',
'thisFormat'   => '<h2>My Rota</h2><br>

<div class="rota-table" id="rota-table">
...
$sql        =   "SELECT * FROM record where `date` = '$todayDate' AND branch ='$branchId' AND userId = '$id'";
$data       =   $this->dbF->getRow($sql);
...
$sqlcheckLeave = "SELECT * FROM `leaves`   where  fill_user = '$id'  AND `status`='accepted' AND `from_date` = '$todayDateT' ";
//echo "<br>";
$datacheckLeave  = $this->dbF->getRow($sqlcheckLeave);
$holidayDate =  "SELECT * FROM `isholiday`   where  `date` = '$todayDateT' AND `user` = '$_SESSION[currentUser]'";
$dataisholiday = $this->dbF->getRow($holidayDate);
$holidayDays =  "SELECT * FROM `practiceprofile`   where  `user_id` = '$_SESSION[currentUser]'";

$staffholidaysdays =  "SELECT * FROM `accounts_user`   where  `acc_id` = '$id'";
$staffholidaysdays  = $this->dbF->getRow($staffholidaysdays);
$dataisholidaydays  = $this->dbF->getRow($holidayDays);
...
$thisFormFields .= "<td class='time ui-droppable $class' style=\"$cursor$style\">$userId $hinput 
...
$form_fields[]  = array(
'type'      => 'none',
'thisFormat'   => '<a class="submit_class rota-btn" style="margin-top:0" href="rota?date2=' . date('d-M-Y', strtotime('-7 day ' . @$_GET['date2'])) . '&date=' . date('d-M-Y', strtotime('-7 day ' . @$_GET['date2'])) . '&rotaweeklysubmit=Create+Weekly+Rota">Prev</a>
<a class="submit_class rota-btn" style="margin-top:0" href="rota?date2=' . date('d-M-Y', strtotime('+7 day ' . @$_GET['date2'])) . '&date=' . date('d-M-Y', strtotime('+7 day ' . @$_GET['date2'])) . '&rotaweeklysubmit=Create+Weekly+Rota">Next</a>
<h2>My Rota</h2><br><div class="rota-table"><table><thead>'
);
...
$sqlcheckLeave = "SELECT * FROM `leaves` where  fill_user = '$id' AND `status`='accepted' AND ('$todayDateT' BETWEEN from_date AND to_date )";
...
$thisFormFields .= "<td class='$isdrop' style=\"$cursor$style\">$userId $hinput 
<div class='col-12 insertTimeTable' style=\"z-index:2; $pointer\">
<div class='row'>
...
<input class='_sn' style='display:none' data-toggle='tooltip' title='Title' type='text' placeholder='No shift Name' value='' name='rshiftname[$todayDate][$id]'  />
...
$chkID =   $this->dbF->getRow("SELECT COUNT(`id`) as cnt FROM `record` WHERE `userId` = '$userId' AND  `date` = '$date'");
if ($chkID['cnt'] > 1) {
    if ($_POST['edit_lock'][$date][$userId] == 0) {
        $this->dbF->setRow("DELETE  FROM `record` WHERE `userId` = '$userId' AND  `date` = '$date' AND edit_lock = 0  ");
    }
}
...
if ($_POST['edit_lock'][$date][$userId] == 0) {
    $this->dbF->setRow("DELETE FROM `record` WHERE id='$id'");
    if ($key == '6') {
        $this->dbF->setRow("DELETE FROM `rotaStatus` WHERE `user`='$userId' AND `week`='$date'");
        $this->dbF->setRow("INSERT INTO `rotaStatus`(`user`,`week`) VALUES('$userId','$date')");
...
$branchId = 0;
$sql    = "DELETE FROM record WHERE userId = '$val[acc_id]' AND date='$date'";
$this->dbF->setRow($sql);
...
$sql = "UPDATE `assigned_paper` SET `feedback` = '$hash' , `star` = '$star' WHERE `assign_id` ='$assign_id'";
...
AND  (`a`.`userId` ='$user' OR `a`.`userId` IN 
(SELECT `id_user` FROM `accounts_user_detail` 
WHERE `setting_val`='$user'  AND `setting_name` = 'account_under' )) AND userId IN (SELECT acc_id FROM accounts_user WHERE acc_type = '1')  
ORDER BY `a`.`date` ASC";
echo "<br>";
$data = $this->dbF->getRows($sql);
$allStaff = array();
...
echo "<tr style='background-color:$valuepp[color]'><td style='background-color:$valuepp[color]'>$ii<td style='background-color:$valuepp[color]'>$nammee";
foreach ($datesarray2 as $val3) {
echo "<td style='background-color:$valuepp[color]'>";
// $day = date('l',strtotime($val2));
...
WHERE `b`.`acc_id`=`a`.`userId`)  as `image` 
FROM `record` as `a` 
WHERE `a`.`date` = '$val3' AND surgeries = '$valuepp[id]' 
AND  (`a`.`userId` ='$user' OR `a`.`userId` IN 
(SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name` = 'account_under' )) 
AND userId IN (SELECT acc_id FROM accounts_user WHERE acc_type = '1')  
ORDER BY `a`.`date` ASC";
$recorddata = $this->dbF->getRows($record);
foreach ($recorddata as $rkey => $rval) {

if(empty($rval['dentist_id'])){
echo "<br><i class='fas fa-user'></i><br>&nbsp;&nbsp;&nbsp;" . $rval['user'] . "<br>(" . $rval['timeFrom'] . "-" . $rval['timeTo'] . ")<br>";
}else{
    echo "<br><i class='fas fa-user'></i>(" . $this->UserName($rval['dentist_id']) . ")<br>&nbsp;&nbsp;&nbsp;" . $rval['user'] . "<br>(" . $rval['timeFrom'] . "-" . $rval['timeTo'] . ")<br>";
}
...
WHERE `b`.`acc_id`=`a`.`userId`)  as `image` 
FROM `record` as `a` 
WHERE `a`.`date` = '$val3' AND surgeries = '' AND timeFrom !='' AND timeFrom !='00:00' AND rotaOff =''
AND  (`a`.`userId` ='$user' OR `a`.`userId` IN 
(SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name` = 'account_under' )) 
AND userId IN (SELECT acc_id FROM accounts_user WHERE acc_type = '1')  
ORDER BY `a`.`date` ASC";
...
if(!empty($rval1)){
  ...
  $record = "SELECT * from leaves where from_date >= '$val3' and to_date <='$val3' and user = $rval1";
...
WHERE `b`.`acc_id`=`a`.`userId`)  as `image` 
FROM `record` as `a` 
WHERE `a`.`date` = '$val3' AND (timeFrom ='' OR timeFrom ='00:00') and rotaOff ='' AND  (`a`.`userId` ='$user' OR `a`.`userId` IN 
(SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name` = 'account_under' )) 
AND userId IN (SELECT acc_id FROM accounts_user WHERE acc_type = '1')  
ORDER BY `a`.`date` ASC";
...
AND  (`a`.`userId` ='$user' OR `a`.`userId` IN 
(SELECT `id_user` FROM `accounts_user_detail` 
WHERE `setting_val`='$user'  AND `setting_name` = 'account_under' )) 
AND userId IN (SELECT acc_id FROM accounts_user WHERE acc_type = '1')  
...
$sql    = "SELECT * FROM accounts_user_detail WHERE id_user = '$userId'";
...
$timef = $this->staffArrayByDate($val, $userId, $date, 'timeFrom');
$timeFrom =  !empty($timef) ? $timef : "00:00";
$timet = $this->staffArrayByDate($val, $userId, $date, 'timeTo');
$timeTo   =  !empty($timet) ? $timet : "00:00";
$sname = $this->staffArrayByDate($val, $userId, $date, 'rshiftname');
$sn   =  !empty($sname) ? $sname : "";
$btime = $this->staffArrayByDate($val, $userId, $date, 'breakTime');
$break   =  !empty($btime) ? $btime : "00:00";
$time = $this->staffArrayByDate($val, $userId, $date, 'rotaComment');
$rotaComment   =  !empty($time) ? $time : "";
$time = $this->staffArrayByDate($val, $userId, $date, 'dentist_id');
$dentist_id   =  !empty($time) ? $time : "";
$col = $this->staffArrayByDate($val, $userId, $date, 'color');
$color   =  !empty($col) ? $col : "";
//  var_dump($col);
...
$rotaOff = $this->staffArrayByDate($val, $userId, $date, 'rotaOff');
if ($rotaOff == 'Holiday') {
$trshow = 1;
...
$trshow = 1;
$style = "style='background-color: #5bc9d6;color: #fff;'";
...
if (!empty($color)) {
$style = "style='background-color: $color; color: #fff; width: 15%;'";
}
...
if ($type == 'event' || $type == 'echeckin' || $type == 'echeckout' || $type == 'echeckinlate' || $type == 'echeckoutlate' || $type == 'covid' ||  $type == 'checkoutforget' ||  $type == 'leavesubmit' ||  $type == 'aretunrtowprk' ||  $type == 'aleave3siknes') {
$user = $this->PracticeId($user);
$email = $this->UserEmail($user);
}
$sql  = "SELECT * FROM `notifications` WHERE `type` = '$type' AND `user` = ? ";
$data = $this->dbF->getRow($sql,array($user));
$sql2 = "SELECT * FROM `email_letters` WHERE `email_type` = '$type'";
$data2 = $this->dbF->getRow($sql2);
$subject = $data2['subject'];
if ($data['push'] == '1') {
$msg = $data2['mesaage_notification'];
}
if ($data['email'] == '1') {
$msg = $data2['message'];
}
...
$msg =  strip_tags($msg);
if ($data['push'] == '1') {
$this->push_notification($subject, $msg, $this->getUserPlayerId($user));
}
if ($data['email'] == '1') {
$this->send_mail($email, $subject, $msg);
}
$sql  = "INSERT INTO `notification_record` (`user`,`type`,`notification`,`playerid`) VALUES (?,?,?,?)";
$array   = array($user, $type, $msg, $this->getUserPlayerId($user));
$this->dbF->setRow($sql, $array);
}
...
$time =  date('H:i', strtotime($_POST['time']));
@$comment = $_POST['comment'];
$sql = "UPDATE `record` SET `checkin`='$time' , `comment`='$comment',`rotaOff` = '' WHERE `userId`='$userId' AND `date` = date(NOW())";
$this->dbF->setRow($sql);
// $lastId = $this->dbF->rowLastId;
}
}
...
$userId = intval($_SESSION['webUser']['id']);
$sql = "SELECT * FROM `lunchtimeInOut` WHERE `dateTime` = date(NOW()) AND `user`='$userId' AND `lunch_in` !='' AND `lunch_out` ='' ";
$data = $this->dbF->getRow($sql);
$id = $data['id'];
if (!empty($data[0])) {
...
public function addCoursCPD_multiple_user()
{
...
$userId = intval($_SESSION['webUser']['id']);
$sql = "SELECT * FROM `record` WHERE `date` = date(NOW()) AND `userId`='$userId'";
$data = $this->dbF->getRow($sql);
if (empty($data[0])) {
...
$time =  date('H:i', strtotime($_POST['time']));
@$comment = htmlspecialchars($_POST['comment']);
$sql = "UPDATE `record` SET `checkin`='$time' , `comment`='$comment' WHERE `userId`='$userId' AND `date` = date(NOW())";
$this->dbF->setRow($sql);
// $lastId = $this->dbF->rowLastId;
...
$this->notifications('checkin');
$this->dbF->setRow("DELETE FROM `cronData` WHERE `user`='$userId' AND `type`='inlate' OR `type`='checkinbefore'");
if ($_SESSION['currentUserType'] == 'Employee') {
...
$sql = "SELECT `checkin`,`breakTime`,`timeTo` FROM `record` WHERE `userId`='$userId' AND `date` = date(NOW())";
$data = $this->dbF->getRow($sql);
$checkin = $data[0];
$break = $data[1];
$CurDate =  date('Y-m-d');
...
$sql = "UPDATE `record` SET `checkout`='$time',`hourWorked`='$difference' , `comment`= concat(comment,'<br>$comment'),`edit_lock` = '1' WHERE `userId`='$userId' AND `date` = '$dateforget'";
$this->dbF->setRow($sql);
// $lastId = $this->dbF->rowLastId;
...
$time =  date('H:i', strtotime($_POST['time']));
@$comment = $_POST['comment'];
$sql = "UPDATE `record` SET `checkin`='$time'  , `comment`= concat(comment,'<br>$comment') WHERE `userId`='$userId' AND `date` = '$dateforget' ";
...
$breaktime = date("G", strtotime($break)) * 60 * 60 + date("i", strtotime($break)) * 60;
$difference = round(abs($time2 - $time1 - $breaktime) / 3600, 2);
$sql = "UPDATE `record` SET `checkout`='$time',`hourWorked`='$difference',`breakTime`='$break' , `comment`= concat(comment,'<br>$comment') ,`edit_lock` = '1' WHERE `userId`='$userId' AND `date` = date(NOW())";
$this->dbF->setRow($sql);
$lastId = $this->dbF->rowLastId;

$this->setlog("Checkout", $this->UserName($userId) . " : $userId","", $time);
$this->notifications('checkout');
$this->dbF->setRow("DELETE FROM `cronData` WHERE `user`='$userId' AND `type`='outlate' OR `type` =  'checkoutbefore'");
if ($_SESSION['currentUserType'] == 'Employee') {
...
{
$sql = "SELECT * FROM `lunchtimeInOut` WHERE  `user`='$userId' AND  `dateTime` ='$CurDate'";
$data = $this->dbF->getRows($sql);
$r = "";
if (!empty($data)) {
...
$date = Date('Y-m-d');
$currentDate =  date('Y-m-d', strtotime($date));
$sql = "DELETE FROM feedback WHERE `user` = '$user'";
$this->dbF->setRow($sql);
...
$sql1 = "SELECT * FROM `accounts_user` WHERE DATE(acc_created) <= DATE(CURDATE() - INTERVAL 3 MONTH) AND `acc_id` = '$user'";
$data1 = $this->dbF->getRow($sql1);
...
echo  $referfriend;
$this->dbF->setRow("DELETE FROM referfriend WHERE `user` = '$user'");
$date = Date('Y-m-d');
$sql  = "INSERT INTO `referfriend` (`user`,`fill`,`show_popup`,`datetime`) VALUES (?,?,?,?)";
$array   = array($user, '0', '1', $currentDate);
$this->dbF->setRow($sql, $array, false);
...
$sql2 = "SELECT * FROM `record` WHERE `date` = date(NOW()) AND `userId`='$user' ";
$data2 = $this->dbF->getRow($sql2);
//var_dump($data2);


$sql3 = "SELECT * FROM `record` WHERE `date` = date(NOW())  AND `userId`='$user'   AND `checkout` !='' AND checkin !='' AND `rotaOff` NOT IN('Holiday','Day Off','Sick') ";


$data3 = $this->dbF->getRow($sql3);
$button = '';

if (!empty($data)) {
echo $button = '<button onclick="window.location.href=\'checkinout?type=checkin\'">Check In</button>';
}
...
$txt = "'" . $txt . "'";
echo $button = '<button onclick="secure_delete333(' . $txt . '); ">Check In</button>';
}

if (!empty($data3)) {

echo $button = '<button  class="" onclick="mycheckout()">Check In</button> 
<script>
function mycheckout() {
...
$data1 = $this->dbF->getRow($sql1);
if (empty($data)) {
echo '<button onclick="window.location.href=\'checkinout?type=checkout\'">Check Out</button>';
if (empty($data1)) {
...
$sql        = "SELECT SUM(hour) as cnt,SUM(hourWorked) as cnthourWorked,userId,branch,
    ...
    (SELECT acc_image FROM accounts_user as b WHERE b.acc_id=a.userId) as image
     FROM record as a WHERE branch = '$branchId'  AND a.date BETWEEN '$from' AND '$to' AND  (`a`.`userId` ='$user' OR `a`.`userId` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name`='account_under')) GROUP BY userId";
$data = $this->dbF->getRows($sql);
...
$sql        = "SELECT *,
    (SELECT `acc_name` FROM `accounts_user` as `b` WHERE `b`.`acc_id`=`a`.`userId`) as `user`,
    (SELECT `acc_image` FROM `accounts_user` as `b` WHERE `b`.`acc_id`=`a`.`userId`) as `image`
     FROM `record` as `a` WHERE userId = '$staffId'  AND `a`.`date` BETWEEN '$from' AND '$to' GROUP BY `date`";
$data       = $this->dbF->getRows($sql);
...
$sql1        = "SELECT * FROM lunchtimeInOut WHERE user = '$userId' and `dateTime` = '$todayDateBasic'";
$lunchdata   = $this->dbF->getRows($sql1);
...
public function leiuInsert()
{
if (!$this->getFormToken('lieuInsert')) {
return false;
}
...
$sql = "DELETE FROM record WHERE userId = '$user[$i]' AND (`date` >= '$from' AND `date` <=  '$to')";
...
public function updateTimeINOUT()
{
...
public function leiuUpdate()
{
if (isset($_POST['edit'])) {
if (!$this->getFormToken('lieuUpdate')) {
return false;
}
$id     = empty($_POST['id'])       ? ""  : $_POST['id'];
$type   = empty($_POST['type'])     ? ""  : $_POST['type'];
...
// CPD
public function InitialCPDedit()
{
...
//echo $sum;
$row2 = "UPDATE `initialCPD` SET $key = '$sum'  WHERE `id` = '$cpdcId'";
$this->dbF->setRow($row2);
}
}
}
}
...
public function editStockLocation()
{
...
$row2 = "UPDATE `product_inventory` SET `location` = '$_POST[location]'  WHERE `qty_pk` = '$_POST[locationPK]'";
$this->dbF->setRow($row2);
...
$row2 = "UPDATE `product_inventory` SET `qty_item` = '$_POST[qty_item]'  WHERE `qty_pk` = '$_POST[qty_itemPK]'";
$this->dbF->setRow($row2);
...
public function editmin_stockPK()
{
...
$row2 = "UPDATE `product_inventory` SET `min_stock` = '$_POST[min_stock]'  WHERE `qty_pk` = '$_POST[min_stockPK]'";
$this->dbF->setRow($row2);
...
$row2 = "UPDATE `product_inventory` SET `expiryDate` = '$_POST[expiryDate]'  WHERE `qty_pk` = '$_POST[expiryDatePK]'";
$this->dbF->setRow($row2);
...
public function InitialCPD()
{
if (isset($_POST['submit'])) {
if (!$this->getFormToken('initial-cpd')) {
return false;
}
...
$this->dbF->setRow("UPDATE `accounts_user_detail` SET `setting_val`='$start_date' WHERE `id_user`='$user' AND `setting_name`='cpd_start_date'");
...
public function CPD_PDP()
{
if (isset($_POST['submit'])) {
if (!$this->getFormToken('cpd-pdp')) {
return false;
}
$cycle      = empty($_POST['cycle'])        ? ""  : $_POST['cycle'];
...
$sql = "SELECT SUM(`minutes`) FROM `assigned_paper` WHERE `assign_user`='$user' AND `result`='completed' AND `assign_paper` IN (SELECT `paper_id` FROM `paper` WHERE `subject_id` IN (SELECT `subject_id` FROM `subjects` WHERE `under`='0'))";
$sql2 = "SELECT SUM(`minutes`) FROM `assigned_paper` WHERE `assign_user`='$user' AND `result`='completed' AND `assign_paper` IN (SELECT `paper_id` FROM `paper` WHERE `subject_id` IN (SELECT `subject_id` FROM `subjects` WHERE `under`!='0'))";
$data = $this->dbF->getRow($sql);
$data2 = $this->dbF->getRow($sql2);
...
$data = $this->dbF->getRow("SELECT setting_val FROM accounts_user_detail WHERE id_user='$_SESSION[currentUser]' AND setting_name = 'cpd_certificates'");
if ($data[0] == '1') {
return false;
} else {
return true;
...
$sqlmin_stock = "SELECT `setting_val` FROM `product_setting` WHERE `setting_name` = 'min_stock' and `p_id` = '$pid'";
$min_stock =  $this->dbF->getRow($sqlmin_stock);
$q = $minStock;
...
global $_e;
if(!$this->getFormToken('addMakeOrder')){
return false;
}
$userId =  $_SESSION['webUser']['id'];
...
$sql = "SELECT COUNT(*) FROM `leaves` WHERE `status`='accepted' AND (`user`  = '$user'  OR `fill_user` = '$user'  )";
}
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0') {
$user = intval($_SESSION['superid']);
$sql = "SELECT COUNT(*) FROM `leaves` WHERE `status`='rejected' AND `fill_user`='$user'";
$data = $this->dbF->getRow($sql);
return $data[0];
} else {
$user = intval($_SESSION['currentUser']);
$sql = "SELECT COUNT(*) FROM `leaves` WHERE `status`='rejected' AND (`fill_user` IN (SELECT `acc_id` FROM `accounts_user` WHERE `acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name`='account_under') OR `acc_id`='$user') OR `fill_user` = '$user')";
}
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0') {
$user = intval($_SESSION['superid']);
$sql = "SELECT COUNT(*) FROM `leaves` WHERE `status`='pending' AND `fill_user`='$user'";
$data = $this->dbF->getRow($sql);
return $data[0];
} else {
$user = intval($_SESSION['currentUser']);
$sql = "SELECT COUNT(*) FROM `leaves` WHERE (`status`='pending' OR `status` = '') AND ( `fill_user` IN (SELECT `acc_id` FROM `accounts_user` WHERE `acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name`='account_under') OR `acc_id`='$user') OR fill_user = '$user' ) ";
}
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
$sql = "SELECT COUNT(*) FROM `record` WHERE `rotaOff`!='' AND `userId` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user' AND `setting_name`='account_under' AND `id_user` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='Dentist')) AND `date` BETWEEN LAST_DAY(CURRENT_DATE())+ INTERVAL 1 DAY - INTERVAL 1 MONTH AND LAST_DAY(CURRENT_DATE())";
$data = $this->dbF->getRow($sql);
return $data[0];
}
...
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0') {
$user = intval($_SESSION['superid']);
$sql = "SELECT * FROM `leaves` WHERE `status`='accepted' AND `fill_user`='$user'";
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
$li = "no leave found";
...
$sql = "SELECT * FROM `leaves` WHERE `status`='Accepted' AND (`user`  = '$user'  OR `fill_user` = '$user'  )";
}
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
...
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0') {
$user = intval($_SESSION['superid']);
$sql = "SELECT * FROM `leaves` WHERE `status`='rejected' AND `fill_user`='$user'";
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
$li = "no leave found";
...
$user = intval($_SESSION['currentUser']);
$sql = "SELECT * FROM `leaves` WHERE `status`='rejected' AND (`fill_user` IN (SELECT `acc_id` FROM `accounts_user` WHERE `acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name`='account_under') OR `acc_id`='$user') OR `fill_user` = '$user')";
}
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
...
<a data-toggle="tooltip" title="Edit" onclick="leaves(this.id)" id="' . $value['id'] . '" class="ablue"><i class="fas fa-edit"></i></a>
 ...
 <button data-id="' . $value['id'] . '" onclick="AjaxDelScript(this);" class="btn edit_btn secure_delete"  >
                <i class="glyphicon glyphicon-trash trash fa fa-trash" ></i>
                <i class="fa fa-refresh waiting fa-spin fa fa-spinner" style="display: none"></i>
            </button>
...
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0') {
$user = intval($_SESSION['superid']);
$sql = "SELECT * FROM `leaves` WHERE (`status`='pending' OR `status` = '' ) AND `fill_user`='$user'";
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
$li = "no leave found";
...
$user =intval($_SESSION['currentUser']);
$sql = "SELECT * FROM `leaves` WHERE (`status`='pending' OR `status` = '') AND ( `fill_user` IN (SELECT `acc_id` FROM `accounts_user` WHERE `acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name`='account_under') OR `acc_id`='$user') OR fill_user = '$user')";
}
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
...
$sql = "SELECT * FROM `record` WHERE `rotaOff`!='' AND `userId` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='$user' AND `setting_name`='account_under' AND `id_user` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='Dentist')) AND `date` BETWEEN LAST_DAY(CURRENT_DATE())+ INTERVAL 1 DAY - INTERVAL 1 MONTH AND LAST_DAY(CURRENT_DATE())";
$data = $this->dbF->getRows($sql);
$li = "";
if (!$data) {
$li = "no leave found";
...
public function employeeleaveInsert()
{

if (isset($_POST['submit'])) {
if (!$this->getFormToken('employeeleaveInsert')) {
return false;
}
$title  = empty($_POST['title'])     ? ""  : $_POST['title'];
...
$this->setlog("Leave Add", $this->UserName($user) . " : " . $user, $lastId, $title);
return true;
} else {
return false;
}
...
if ($this->dbF->rowCount > 0) {
$this->notifications('leavesubmit', $_SESSION['webUser']['id'], $type);
$this->setlog("Leave Add", $this->UserName($user) . " : " . $user, $lastId, $title);
return true;
} else {
return false;
...
$this->db->commit();
if ($this->dbF->rowCount > 0) {
$data = $this->dbF->getRow("SELECT `fill_user` FROM `leaves` WHERE `id` = '$id'");
$filluser =   $data[0];
$user;
if ($status == "Accepted" || $status == "Rejected") {
    if ($status == 'Accepted'  || $status == 'Rejected') {
        ...
        $this->notifications('uleavestatus', $filluser, $title);
    }
    $this->setlog("Leave Update", $this->UserName($filluser) . " : " . $user, "", $title);
}
return true;
} else {
return false;
...
WHERE  `user` IN (SELECT `id_user`FROM `accounts_user_detail` WHERE `setting_val`='$user'  AND `setting_name`='account_under')OR `user`='$user' AND `a`.`acc_type` = '1' "; //AND status = 'accepted'
...
public function leavesCalendar()
{
if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hrdashboard'] == '0') {
$user = $_SESSION['superid'];
$sql = "SELECT
...
$this->db->commit();
if ($this->dbF->rowCount > 0) {
$this->notifications('aretunrtowprk', $fill_user, 'Return Work Form');
...
$phpmailer_mail->IsMail();  
                  ...
                  $phpmailer_mail->From       = 'webmaster@smartdentalcompliance.com';
                  $phpmailer_mail->Sender     = 'webmaster@smartdentalcompliance.com';
                  $phpmailer_mail->SetFrom('webmaster@smartdentalcompliance.com', 'smartdentalcompliance', FALSE);
                  // $phpmailer_mail->addCustomHeader($headers);
                  $phpmailer_mail->AddAddress($to);
                  $phpmailer_mail->AddReplyTo('webmaster@smartdentalcompliance.com', 'smartdentalcompliance');
...
$sql        = "SELECT $fields FROM `accounts_user` WHERE `acc_id` = '$id'";
$userData   =   $this->dbF->getRow($sql);
...
public function accident_form_report_issue()
{

if (isset($_POST['submit'])) {
if (!$this->getFormToken('accident_form_report_issue')) {
return false;
}
...
public function submitclientIssue()
{
...
if ($_SESSION['currentUserType'] == 'Employee') {
$pstore = $_SESSION['superid'];
}
else{
$pstore = $_SESSION['currentUser'];
            ...
            @$hashVal=$pid.":".$pscale.":".$pcolor.":".$store;
                ...
                if($_POST['receipt_publish']=='publish'){ 
                   ...
                   if($this->dbF->rowCount>0){
                       $sql="UPDATE `product_inventory` SET `qty_item` = $qty WHERE `qty_product_id`='$pid' AND `qty_store_id`='$pstore' AND `product_store_hash`='$hash'";
                       $this->dbF->setRow($sql);
                   }
                   else{
