...
$mysql = "DELETE FROM `myeventsFilled` WHERE `my_e_id`='$edit_id'";
$this->dbF->setRow($mysql);
...
if(!$isApi){
    $sql.= "IF(`status`='complete' AND approved = '1','#808080',(IF(`color_publish` = '0','#01abbf','#01abbf')))as color,";
}
...
$sql4 = "SELECT 
        ...
        if(!$isApi){
        $sql4 .= "IF(`status`='complete' AND approved = '1','#808080',(IF(`color_publish` = '0','#01abbf','#01abbf')))as color,";
        }
...
$user     = empty($_POST['user'])   ? ""    : $_POST['user'];
$desc     = empty($_POST['desc'])   ? ""    : $_POST['desc'];
$c_date   = empty($_POST['c_date']) ? ""    : date('Y-m-d', strtotime($_POST['c_date']));
...
$array   = array($practice_name, $practice_manager_name, $practice_address, $telephone, $staff, $information, $surgeries, $room,
$autoclave, $disinfectors, $ultrasonic, $compressor, $npm, $sedation, $domiciliary, $practice_logo,
$team_image, $day, $subt_name, $number_of_radiation_machines, $serial_number, $name_of_RPA_advisor,
$name_of_RPA_supervisor, $Last_service_date, $pinVarification);
$this->dbF->setRow($sql, $array, false);
// $lastId = $this->dbF->rowLastId;
$this->db->commit();
