...
$sql2 = "SELECT `userevent`.`id`,`userevent`.`due_date`,`title`,`category`,`type`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`!= 'updates' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
$sql2 = "SELECT `userevent`.`id`,`userevent`.`due_date`,`title`,`category`,`type`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`= ? AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
// $sql2 = "SELECT `userevent`.`id`,`userevent`.`due_date`,`title`,`category`,`type`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`<=(SELECT CURDATE()) ORDER BY `title`";
...
$sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`!= 'updates' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
$sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='$a' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
// $sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`<=(SELECT CURDATE())";
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `type`='mandatory' AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `type`='recommended' AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='mandatory' AND `due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE  `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type`='mandatory' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$data = $this->dbF->getRow($sql, array($user, $user));
$data2 = $this->dbF->getRow($sql2, array($user));
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='mandatory' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='mandatory' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$data = $this->dbF->getRow($sql, array($user, $user));
$data2 = $this->dbF->getRow($sql2, array($user));
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='mandatory' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN  AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='recommended' AND `due_date` > DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='recommended' AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type`='recommended' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$data = $this->dbF->getRow($sql, array($user, $user));
$data2 = $this->dbF->getRow($sql2, array($user));
return $data[0] + $data2[0] + 0;
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='recommended' AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$sql2 = "SELECT COUNT(*) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ? AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type`='recommended' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
$data = $this->dbF->getRow($sql, array($user, $user));
$data2 = $this->dbF->getRow($sql2, array($user));
return $data[0] + $data2[0] + 0;
}
...
{
$sql = "SELECT COUNT(*) FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `type`='mandatory' AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
$sql2 = "SELECT DISTINCT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ? AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`>(SELECT CURDATE()) AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id= ? AND type='event')";
$data = $this->dbF->getRows($sql, array($user, $user));
...
$sql2 = "SELECT COUNT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`>(SELECT CURDATE()) AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id= ?  AND type='event')";
$data = $this->dbF->getRow($sql, array($user, $user));
...
FROM   `userevent`
       JOIN `eventmanagement`
         ON `eventmanagement`.`id` = `userevent`.`title_id`
WHERE  (`userevent`.`approved`='0' OR `userevent`.`approved`='-1')
       AND `user` =  ? 
...
$percent = $ttlDone/$ttl; if(is_int($percent) || is_float($percent)) $percent=number_format( $percent * 100); else $percent=0;
if($percent=='Nan'){
    $percent=0;
}
...
$sql2 = "SELECT COUNT(`category`) FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`<=(SELECT CURDATE()) AND `type` !='updates' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')";
...
$sql = "SELECT * FROM `eventmanagement` WHERE `assignto` IN ('all','$user') AND `publish` = '1' AND `due_date`<=(SELECT CURDATE()) AND id NOT IN(SELECT title_id FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE `approved` IN ('1','0','-1') AND `user`='$user') AND id NOT IN (SELECT recurrence FROM eventmanagement) AND `type` !='updates' AND id NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event') ORDER BY `title`";
$sql2 = "SELECT `userevent`.`id`,`userevent`.`due_date`,`title`,`category`,`type`,`userevent`.`file` as `userfile`,`approved`,`userevent`.`assignto`,`userevent`.`dateTime` FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`assignto` < '1' AND `userevent`.`due_date`<=(SELECT CURDATE()) AND `type` !='updates'  AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event') ORDER BY `title`";
$data = $this->dbF->getRows($sql);
$data2 = $this->dbF->getRows($sql2);
$mysql = $this->setli($data);
$mysql .= $this->setli($data2, 'editevent');
...
foreach ($data as $key => $value) {
    ...
    if ($page == 'editevent') {
        ...
        $li .= ' <span style="position: relative;
            top: 0px;">(' . date("d-M-Y", strtotime($value['due_date'])) . ')</span>';
        // } else {
...
// $sqlFormCheck = "SELECT * FROM `myeventform` WHERE `title_id`=? AND `publish`=?";
// @$dataFormCheck = $dbF->getRows($sqlFormCheck,array($title_id,"1"));
// if (empty(@$dataFormCheck)) {
if (count($fid)==0) {
    $title_id = $title_id;
    $question = empty($_POST['question'])    ? array()     : $_POST['question'];
    $categoryS = empty($_POST['categoryS'])  ? array()     : $_POST['categoryS'];
...
//email
public function dueEvent($user,$acc_type="",$pid="")
{

if($acc_type == 'Employee'){
    // echo $pid;
    
    // $sql = "SELECT title FROM `eventmanagement` WHERE `assignto` IN ('all',$user') AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `assignto`='$user') AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `type` !='updates'";
    // $data = $this->dbF->getRows($sql);
        
    $temp=$this->allGroupsIds($user);
    
    $sql = "SELECT  * FROM `myevents` WHERE `assignto` IN ('-1.$pid','$user'$temp) AND `due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND (`status`!='deleted' AND `status`!='complete')";
    $data = $this->dbF->getRows($sql);
    
    $sql2 = "SELECT title FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`userevent`.`approved`='0' OR `userevent`.`approved`='-1') AND `userevent`.`assignto` IN ('-1.$pid','$user'$temp) AND `userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type` !='updates'";
    $data2 = $this->dbF->getRows($sql2);
    ...
    $sql2 = "SELECT title FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`due_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL -1 DAY) AND DATE_SUB(CURDATE(), INTERVAL -1 MONTH) AND `type` !='updates'";
    $data = $this->dbF->getRows($sql);
    $data2 = $this->dbF->getRows($sql2);
...
public function overdueEvent($user,$acc_type,$pid)
{
...
if($acc_type == 'Employee'){
    ...
    $sql = "SELECT  * FROM `myevents` WHERE `assignto` IN ('-1.$pid','$user'$temp) AND `due_date` <= (SELECT CURDATE()) AND (`status`!='deleted' AND `status`!='complete')";
    $data = $this->dbF->getRows($sql);
    
    $sql2 = "SELECT title FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `userevent`.`assignto` IN ('-1.$pid','$user'$temp)  AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type` !='updates'";
    $data2 = $this->dbF->getRows($sql2);

}else{
    
    $sql = "SELECT title FROM `eventmanagement` WHERE `assignto` IN ('all', ? ) AND `due_date` <= (SELECT CURDATE()) AND `id` NOT IN (SELECT `title_id` FROM `userevent` WHERE `user`= ? ) AND `publish` = '1' AND `id` NOT IN (SELECT `recurrence` FROM `eventmanagement`) AND `type` !='updates'";
    $sql2 = "SELECT title FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`= ?  AND `userevent`.`due_date` <= (SELECT CURDATE()) AND `type` !='updates'";
    $data = $this->dbF->getRows($sql,array($user,$user));
    $data2 = $this->dbF->getRows($sql2,array($user));
...
function notSubmitStaffDoc($emailType,$id,$acc_name,$acc_email){
 
// $user = $_SESSION['webUser']['id'];
// $pid = $_SESSION['currentUser'];

// $sql    = "SELECT * FROM accounts_user WHERE acc_type = 1 AND acc_id = '6652'";
// $data   = $this->dbF->getRows($sql);
...
$query = "SELECT setting_val from accounts_user_detail where id_user = '$id' AND setting_name = 'account_under'";
$row =  $this->dbF->getRow($query);

$acc_under = $row['setting_val'];

$sql1  = "SELECT * FROM `documents` WHERE (`assignto` IN ('all','$id','all:$acc_under')  
            AND `category`='Training' 
            AND (`id` NOT IN (SELECT `title_id` FROM `userdocuments` WHERE `user`='$id' AND expiry_date > CURDATE() )))";
$doc1 =  $this->dbF->getRows($sql1);

$training = "<div style='width:95%;margin:auto;'>";
// $t = $docs['title'];
foreach($doc1 as $key => $val){
    $training .= "<div style='width:20%;margin:10px;padding:5px;text-align:center;background-color:#FED049;display:inline-block;vertical-align:top;'>" . $val['title'] . "</div>"; 
}
$training .= "</div>";

if (empty($doc1)) {
$training = "<br>You Have No Training Documents<br>";
$mailArray['training'] = $training;
} else {
$mailArray['training'] = $training;
}
...
$sql2  = "SELECT * FROM `documents` WHERE (`assignto` IN ('all','$id','all:$acc_under') 
            AND `category`='Recruitment' 
            AND (`id` NOT IN (SELECT `title_id` FROM `userdocuments` WHERE `user`='$id' AND expiry_date > CURDATE() )))";
$doc2 =  $this->dbF->getRows($sql2);

$recruitment = "<div style='width:95%;margin:auto;'>";
// $t = $docs['title'];
foreach($doc2 as $key => $val){
    $recruitment .= "<div style='width:20%;margin:10px;padding:5px;text-align:center;background-color:#68B984;display:inline-block;vertical-align:top;'>" . $val['title'] . "</div>";
}
$recruitment .= "</div>";

if (empty($doc2)) {
$recruitment = "<br>You Have No Recruitment Documents<br>";
$mailArray['recruitment'] = $recruitment;
} else {
$mailArray['recruitment'] = $recruitment;
}
...
$sql3  = "SELECT * FROM `documents` WHERE (`assignto` IN ('all','$id','all:$acc_under') 
            AND `category`='Signed Policies' 
            AND (`id` NOT IN (SELECT `title_id` FROM `userdocuments` WHERE `user`='$id' AND expiry_date > CURDATE() )))";
$doc3 =  $this->dbF->getRows($sql3);

$policy = "<div style='width:95%;margin:auto;'>";
// $t = $docs['title'];
foreach($doc3 as $key => $val){
    $policy .= "<div style='width:20%;margin:10px;padding:5px;text-align:center;background-color:#b19cd9;display:inline-block;vertical-align:top;'>" . $val['title'] . "</div>";
}
$policy .= "</div>";

if (empty($doc3)) {
$policy = "<br>You Have No Signed Policies Documents<br>";
$mailArray['policy'] = $policy;
} else {
$mailArray['policy'] = $policy;
}
...
// $mailArray['name']        =   $acc_name;

// $email = "basitabbas2001@gmail.com";

// $this->send_mail($email,'','',$emailType,$acc_name,$mailArray);


// $mailArray = $this->makeMsgForEmail($data2, $acc_email, $acc_name, $mailArray);


$subject = str_replace('{{name}}',$acc_name,$subject);
$msg = str_replace('{{name}}',$acc_name,$msg);
$msg = str_replace('{{training}}',$training,$msg);
$msg = str_replace('{{recruitment}}',$recruitment,$msg);
$msg = str_replace('{{policy}}',$policy,$msg);

$sql = "INSERT into `email_record` (`user`,`type`,`subject`,`email`,`mail`,`player_id`) VALUES (?,?,?,?,?,?)";
$array   = array($id, $emailType,$subject,$acc_email, $msg, $this->getUserPlayerId($id));
$this->dbF->setRow($sql, $array);

$sql = "INSERT into `email_queue` (`email_to`,`subject`,`message`) VALUES (?,?,?)";
$this->dbF->setRow($sql, array($acc_email,$subject,$msg));
...
function notSubmitStaffDoc_old($emailType){
...
$sql1  = "SELECT * FROM `documents` WHERE (`assignto` IN ('all','$id','all:$acc_under')  AND `category`='Training' AND (`id` NOT IN (SELECT `title_id` FROM `userdocuments` WHERE `user`='$id')))";
$doc1 =  $this->dbF->getRows($sql1);

$training = "<ul>";
// $t = $docs['title'];
foreach($doc1 as $key => $val){
    $training .= "<li>" . $val['title'] . "</li><br>"; 
}
$training .= "</ul>";

if (empty($doc1)) {
$training = "<br><br>You Have No Training Documents<br><br>";
} else {
$mailArray['training'] = $training;
}
...
$sql2  = "SELECT * FROM `documents` WHERE (`assignto` IN ('all','$id','all:$acc_under') AND `category`='Recruitment' AND (`id` NOT IN (SELECT `title_id` FROM `userdocuments` WHERE `user`='$id'))) AND (`id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$id' AND type='documents'))";
$doc2 =  $this->dbF->getRows($sql2);

$recruitment = "<ul>";
// $t = $docs['title'];
foreach($doc2 as $key => $val){
    $recruitment .= "<li>" . $val['title'] . "</li><br>"; 
}
$recruitment .= "</ul>";

if (empty($doc2)) {
$recruitment = "<br><br>You Have No Recruitment Documents<br><br>";
} else {
$mailArray['recruitment'] = $recruitment;
}
...
$sql3  = "SELECT * FROM `documents` WHERE (`assignto` IN ('all','$id','all:$acc_under') AND `category`='Signed Policies' AND (`id` NOT IN (SELECT `title_id` FROM `userdocuments` WHERE `user`='$id'))) AND (`id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$id' AND type='documents'))";
$doc3 =  $this->dbF->getRows($sql3);

$policy = "<ul>";
// $t = $docs['title'];
foreach($doc3 as $key => $val){
    $policy .= "<li>" . $val['title'] . "</li><br>"; 
}
$policy .= "</ul>";

if (empty($doc3)) {
$policy = "<br><br>You Have No Signed Policies Documents<br><br>";
} else {
$mailArray['policy'] = $policy;
}
...
$due_date   = empty($_POST['due_date'])  ? date('Y-m-d')    : date('Y-m-d', strtotime($_POST['due_date']));
$sql = "SELECT * FROM `userevent` WHERE `due_date` = '$due_date' AND `due_date` != '' AND (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `title_id` IN (SELECT `id` FROM `eventmanagement` WHERE `recurring_duration` IN ('1 day','1 week'))";
$data = $this->dbF->getRows($sql);
foreach ($data as $key => $value) {
$user       = $value['user'];
$edit_id    = $value['id'];
...
$sql2 = "SELECT 
      ...
      IF(`userevent`.`dateTime` = '' || `userevent`.`due_date` > `userevent`.`dateTime`  ,DATE_FORMAT(`userevent`.`due_date`,'%Y-%m-%d'),DATE_FORMAT(`userevent`.`dateTime`,'%Y-%m-%d')) as start,
        ...
        IF(`userevent`.`due_date`<=(SELECT CURDATE()),'overdue','upcoming') AS status,
         IF(`eventmanagement`.`type` = 'mandatory', '#ff0000', IF(`eventmanagement`.`type` = 'recommended', '#00b58a', IF(`eventmanagement`.`type` = 'updates', '#a101b9','orangeborder'))) as color
         FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user'";
...
$sql2 = "SELECT 
 ...
 FROM `userevent` JOIN `eventmanagement` ON `eventmanagement`.`id` = `userevent`.`title_id` WHERE (`approved`='0' OR `approved`='-1') AND `user`='$user' AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event') ";
...
<div class="row-icons">';
        if ($value['file'] == '#') {
            if ($_SESSION['currentUserType'] != 'Employee' || $_SESSION['webUser']['account_type'] != 'Employee' || $_SESSION['superUser']['myuploads'] == 'full') {
 ...
 <!-- row-icons -->
      ...
      if ($_SESSION['currentUserType'] != 'Employee' || $_SESSION['webUser']['account_type'] != 'Employee' || $_SESSION['superUser']['myuploads'] == 'edit' || $_SESSION['superUser']['myuploads'] == 'full') {
...
$msg =  strip_tags($msg);
    ...
    if ($data['email'] == '1' || $data2['type'] == 'admin') {
        if ($type != 'checkout' && $type != 'checkin' && $type != 'echeckin' && $type != 'echeckout' && $type != 'echeckinlate' && $type != 'echeckoutlate' &&  $type != 'checkoutforget') {
            $this->send_mail($email, $subject, $msg);
        }else{
            $sql = "INSERT into `email_queue` (`email_to`,`subject`,`message`) VALUES (?,?,?)";
            $this->dbF->setRow($sql, array($email,$subject,$msg));
        }
    ...
    if ($type != 'checkout' && $type != 'checkin' && $type != 'echeckin' && $type != 'echeckout' && $type != 'echeckinlate' && $type != 'echeckoutlate' &&  $type != 'checkoutforget') {
        $sql = "INSERT into `email_record` (`user`,`type`,`subject`,`email`,`mail`,`player_id`) VALUES (?,?,?,?,?,?)";
        $array   = array($user, $type,$subject,$email, $msg, $this->getUserPlayerId($user));
        $this->dbF->setRow($sql, $array);
    }
...
$CurDate =  date('Y-m-d');
$time =  date('H:i', strtotime($_POST['time']));
$sql = "INSERT INTO `record`(`userId`,`timeFrom`, `timeTo`, `date`,`comment`,`checkin`,`shift`)VALUES (?,?,?,?,?,?,'1')";
...
$sql = "SELECT `checkin`,`breakTime`,`timeTo` FROM `record` WHERE `userId`= ? AND `date` = ? AND `shift` = ?";

$data = $this->dbF->getRow($sql, array($userId, $dateforget[0], $dateforget[1]));
$checkin = $data[0];
$break = $data[1];
// $CurDate =  date('Y-m-d');
$CurDate =  $dateforget[0];
$break =$this->calculateTTLBreak($userId,$CurDate);
$time1 = strtotime($checkin);
$time2 = strtotime($time);
if(trim($break) !=''){ $breaktime = date("G", strtotime($break)) * 60 * 60 + date("i", strtotime($break)) * 60; }
$difference = round(abs($time2 - $time1 - $breaktime) / 3600, 2);
$Tcomment = 'concat(comment,<br>'.$comment.')';
$sql = "UPDATE `record` SET `checkout`= ? ,`hourWorked`= ? , `comment`=  ? ,`edit_lock` = '1' WHERE `userId`= ? AND `date` = ? AND `shift` = ? ";
...
$difference = round(abs($time2 - $time1 - $breaktime) / 3600, 2);
$Tcomment = $comment;
$sql = "UPDATE `record` SET `checkout`= ? ,`hourWorked`= ? ,`breakTime`= ? , `comment`= concat(comment, ?) ,`edit_lock` = '1' WHERE `userId`= ?  AND `shift`= ? AND `date` = date(NOW())";
...
function someDayOfSignup($emailType,$variation){
 ...
 $sql1  = "SELECT * FROM accounts_user WHERE DATE_FORMAT(acc_created, '%Y-%m-%d') = curdate() - INTERVAL $variation DAY AND acc_type = 1 AND
`acc_id` NOT IN (SELECT `id_user` FROM `accounts_user_detail` WHERE setting_val='Trial')  ORDER BY `accounts_user`.`acc_created` DESC limit 1";
$data1 =  $this->dbF->getRows($sql1);
if ($this->dbF->rowCount > 0) {
$tableTr = "";  
...
// $acc_email = 'basitabbas2001@gmail.com';
...
function someDayOfTrial($emailType,$variation){
 $emailType= $emailType.''.$variation;
 $sql1  = "SELECT * FROM accounts_user WHERE DATE_FORMAT(acc_created, '%Y-%m-%d') = curdate() - INTERVAL $variation DAY AND acc_type = 1 AND
`acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE setting_val='Trial')";
$data1 =  $this->dbF->getRows($sql1);
if ($this->dbF->rowCount > 0) {
$tableTr = "";  
foreach($data1 as $val){
...
// $this->send_mail($acc_email,'','',$emailType,$acc_name,$mailArray);
...
function notLoggedinTrial($emailType,$variation){
 $emailType= $emailType.''.$variation;
 $sql1  = "SELECT * FROM accounts_user WHERE DATE_FORMAT(last_login, '%Y-%m-%d') = curdate() - INTERVAL $variation DAY AND acc_type = 1 AND
`acc_id` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE setting_val='Trial')";
$data1 =  $this->dbF->getRows($sql1);
if ($this->dbF->rowCount > 0) {
$tableTr = "";  
    ...
    // if($data[0]['shift'] != ''){
        ...
        if($timefrom1 < $timefrom) {
                if($timeto>$currentTime){
                   echo $button = '<button onclick="window.location.href=\'checkinout?type=checkin&shift='."1".'\'">Check In</button>';
                //   echo 1;
                }else{
                        echo $button = '<button onclick="window.location.href=\'checkinout?type=checkin&shift='."2".'\'">Check In</button>';
                    //   echo 2;
                }
        }else{
             echo $button = '<button onclick="window.location.href=\'checkinout?type=checkin&shift='."2".'\'">Check In</button>';
        ...
        if(!empty($data5)){
        echo $button = '<button onclick="window.location.href=\'checkinout?type=checkin&shift='.$data[0]['shift'].'\'">Check In</button>';}
        // echo 4;
    }
}
...
$sql = "SELECT `checkin`,`breakTime`,`timeTo`,`date`,`userId` FROM `record` WHERE `id`=?";

$data = $this->dbF->getRow($sql, array($id));
$CurDate =  $data[3];
$userId =  $data[4];
$breakTime =$this->calculateTTLBreak($userId,$CurDate);

$time1 = strtotime($checkin);
$time2 = strtotime($checkout);
// $final = $time2-strtotime($breakTime);
if(trim($breakTime) !=''){ $breaktime = date("G", strtotime($breakTime)) * 60 * 60 + date("i", strtotime($breakTime)) * 60; }
...
$li .= '<li>
<div class="col4_main_left1" data-toggle="tooltip" title="' . $name . ' : ' . $value['type'] . '">
' . $value['title'] . '&nbsp;<span>(' . $name . ')</span><span>(' . $value['type'] . ')</span>
<span>(' . date("d-M-Y", strtotime($value['from_date'])) . ' - ' . date("d-M-Y", strtotime($value['to_date'])) . ')</span>
</div><!-- col4_main_left1 close -->';
if ($_SESSION['currentUserType'] != 'Employee' ||  $_SESSION['superUser']['hrrota'] == 'full') {
$li .= '<div class="col4_main_left3">
...
$sql = "SELECT * FROM `record` WHERE `rotaOff`!='' AND `rotaOff`!='0' AND `userId` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`= ?  AND `setting_name`='account_under' AND `id_user` IN (SELECT `id_user` FROM `accounts_user_detail` WHERE `setting_val`='Dentist')) AND `date` BETWEEN LAST_DAY(CURRENT_DATE())+ INTERVAL 1 DAY - INTERVAL 1 MONTH AND LAST_DAY(CURRENT_DATE())";
// $sql = "SELECT * FROM `leaves` WHERE (`status`='pending' OR `status` = '' ) AND `fill_user`= ? ";
$data = $this->dbF->getRows($sql ,array($user));
$li = "";
if (!$data) {
...
if (isset($mailArray['training'])) {
$temp = $mailArray['training'];
$msg        =   str_ireplace("{{training}}", $temp, $msg);
}
if (isset($mailArray['recruitment'])) {
$temp = $mailArray['recruitment'];
$msg        =   str_ireplace("{{recruitment}}", $temp, $msg);
}
if (isset($mailArray['policy'])) {
$temp = $mailArray['policy'];
$msg        =   str_ireplace("{{policy}}", $temp, $msg);
}
...
WHERE   (`userevent`.`approved`='0' OR `userevent`.`approved`='-1')
      ...
      AND `userevent`.`title_id` NOT IN (SELECT files_id FROM `practiceFileSelection` WHERE user_id='$user' AND type='event')
...
if (isset($_POST['practiceIds']) && !empty($_POST['practiceIds']))  {
    ...
    // foreach ($practiceIds as $key => $ids) {
           ...
           $sql = "INSERT INTO `filesmanager`(`title`, `file`, `category`,`sub_category`,`sub_sub_category`,`assignto`,`publish`)
            ...
            $array = array($title,$docname,$category,$sub_category,$sub_sub_category,$user,'1');
            // var_dump($array);
            // exit();
            $this->dbF->setRow($sql, $array, false);
...
{
    // $user=$_SESSION['currentUser'];
    $d = $this->dbF->getRow("SELECT `setting_val` FROM `accounts_user_detail` WHERE `setting_name`='account_under' AND `id_user`='$id'");
    $data= $this->dbF->getRows("SELECT Distinct group_id FROM `insertGroup` WHERE users='$id' AND practiceID='$d[0]'");
$temp=",";
$size= sizeof($data);
$i=1;
foreach ($data as $value) {
...
foreach ($data as $key => $value) {
$grpID='G.'.$value['group_id'];
if($grpID === $assignto){
    $op .= "<option selected value='$grpID' a='$assignto'>$value[group_name]</option>";
}else{
    $op .= "<option value='$grpID'>$value[group_name]</option>";
}
