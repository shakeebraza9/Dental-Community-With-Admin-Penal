...
<a href='profile?page=Edit Profile&userId=$value[acc_id]' style=';position: absolute;right: 10px;top: 10px;'><i class='fas fa-edit' data-toggle='tooltip' title='Edit Profile'></i></a>
$deactive
...
if($dataAll){
  ...
  $sql2a      =   "INSERT INTO `product_size`(`prosiz_name`,`prosiz_prodet_id`,`prosiz_cur_id`,`prosiz_price`,`sizeGroup`) VALUES (?,?,?,?,?)";
                $this->dbF->setRow($sql2a,array($data['scale_name'],$lastId,'20','0',$data['scale_name_id']));
