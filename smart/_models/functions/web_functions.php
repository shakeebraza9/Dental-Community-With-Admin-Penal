...
if($page == 'Add Profile'){
    ...
    $devicenotification = "smart dental";
...
echo '<form class="profile" action="'.$action.'" role="form" method="post" enctype="multipart/form-data">'.$token.'
    <input type="hidden" name="oldId" value="'.@$id.'" />
    <div id="tabs">  
        <ul>
            <li><a href="#tabs-1">Personal Details</a></li>
            <li><a href="#tabs-2">Work Details</a></li>
            <li><a href="#tabs-3">HR Details</a></li>
            <li><a href="#tabs-4">Payment Details</a></li>
            <li><a href="#tabs-5">CPD Details</a></li>
            <li><a href="#tabs-6">Password</a></li>
      ...
      if(($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['superuser_access'] == 'full') || $_SESSION['currentUserType'] == 'Master' || $_SESSION['currentUserType'] == 'Practice'){
           ...
           echo    '<li><a href="#tabs-8" >Super User</a></li>
            <li><a href="#tabs-9">MemberShip</a></li>';
          }
            else{
         echo    '<li><a href="#tabs-8" '.$hide.'>Super User</a></li>
            <li><a href="#tabs-9" '.$hide.'>MemberShip</a></li>';
             } 
...
if($this->webUserInfoArray($userInfo,'superuser')=='on'){
       ...
       echo '</div>
         <div id="tabs-9"><div style="padding:10px"> ';
    ...
    echo ' <h3>Membership Detail</h3>';
       if($data == true)
       {
        echo '<div class="">'.$this->membership($id).'</div> <div class ="hideshow"  style=" "></div>
        </div><style>
        .hideshow{
       ...
       else
       {
          ...
          <style>
        .hideshow{
           top: 110px; width: 275px; height: 72px;; background-color: #e5f3f2;  z-index: 99999999; position: absolute;
        }
