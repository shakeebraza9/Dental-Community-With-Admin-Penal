...
<li class="dash-btn"><a href="https://smartdentalcompliance.com/stockView#tabs-2"><i class="fas fa-plus"></i>Add Existing Stock</a></li>


<li class="dash-btn"><a href="#"><i class="fas fa-plus"></i>Add Incoming Stock</a></li>
<li class="dash-btn"><a href="https://smartdentalcompliance.com/stockOrder"><i class="fas fa-table"></i>Stock Received</a></li>
<li class="dash-btn"><a href="https://smartdentalcompliance.com/stockView"><i class="fas fa-list"></i>View Stock Per Locations</a></li>
