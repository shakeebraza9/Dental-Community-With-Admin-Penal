        ...
        <div class="newloginRight">
            ...
            <div class="newcontent_logo">
                <a>
                    ...
                    <h4>Welcome Back</h4>
                    <h5><a style="color: #561d94;" href="<?php echo WEB_URL ?>/login">Login to AIOM</a></h5>
                </a>
            </div>
            <!-- content_logo close -->
            <?php if($msg!=''){ ?>
            ...
            <div class="newfoot">
<p>© Copyright 2019 - <?php echo date('Y')?> <a href="<?php echo WEB_URL ?>"> Smart Dental Compliance </a> All Rights Reserved.
</p>
</div> 
        </div>
        <!-- login-center -->
