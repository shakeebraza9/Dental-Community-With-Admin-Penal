...
if($data['type'] != "updates"){            
    if($data['file'] != '#') {
        ...
        echo $functions->downloadButton($data['file'],false);
            ...
            ?>
    <div class='DelScript'>
<a href="javascript:;" class="dbtn" style="float: right;" onclick="copyEvents(this.id)" id="<?php echo $data['id'] ?>" data-toggle="tooltip" title="Customise this event"><i class="fas fa-copy"></i>Customise this event</a></div>
<?php
                   ...
                   <div class="row">
                    ...
                    <?php if ($_SESSION['currentUserType'] == 'Employee' && $_SESSION['superUser']['hruser'] == '0') {   
                     ...
                     <div class="form-group col-sm-6">
                        <a href="" id="<?php echo $user.":event:".$data['id'] ?>" onclick="changeUserDoc(this.id)" data-toggle="tooltip"  title="Delete Event"><i class="fas fa-trash" style="font-size:22px; margin-top: 5px; color: rgb(86, 29, 148);"></i></a>
                    </div>  
                    <?php }?> 
                    </div>
                    <div class="row">
                       <div class="form-group col-sm-6" <?php echo @$display ?>>
                            <label>Completion Date :</label>
                            <input class="datepicker" type="text" name="date" value="<?php echo $cdate ?>" required autocomplete="off" readonly>
                        </div>
                   
                        <div class="form-group col-sm-6 duedate" style="display: none;">
                            <label>Due Date :</label>
                             <input class="datepicker" type="text" value="<?php echo $data2duedate ?>" name="due_date">
                        </div>
	...
	$data9 = $dbF->getRow($sql9);
            ...
            //              $data8['ue_id'];
                        ...
                        <input name="form[<?php echo $key ?>][question]" type="hidden" value="<?php echo $value['id'] ?>">
                            ...
                            <div class="form-group col">
                              ...
                              <label for="<?php echo $value['field1']?>">
                                ...
                                <input name="form[<?php echo $key ?>][field1]" type="text" class="require" value="<?php echo $datatmp ?>">
                            </div> 
                            ...
                            <div class="form-group col">
                                ...
                                <input name="form[<?php echo $key ?>][field2]" type="text" class="require" value="<?php echo $datatmp ?>">
                            </div> 
                            <?php } ?>
                ...
                ?>
                    ...
                    <div class="form-group">
                        <label>Comment:</label>
                        <textarea name="comment" class="require"><?php echo $data2['comment'];?></textarea>
                    </div>
                    <!-- form-group -->
                    <!-- form-group -->
                    <?php } ?>
