...
<h2 class="sub_heading"><?php echo $_e['Manage WebUsers'];?></h2>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist">
        ...
        <li class=""><a href="#trial" role="tab" data-toggle="tab"><?php echo $_e['Trial Accounts'];?></a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade in container-fluid" id="trial">
            <h2  class="tab_heading"><?php echo $_e['UnVerify Users'];?></h2>
            <?php $webUsers->webUsersTrial();  ?>
        </div>
