...
<h2 class="sub_heading"><?php echo _uc($_e['Manage Shift']); ?></h2>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist">
        <li class="active"><a href="#home" role="tab" data-toggle="tab"><?php echo _uc($_e['Shift']); ?></a></li>
        <li><a href="#draft" role="tab" data-toggle="tab"><?php echo _uc($_e['Draft']); ?></a></li>
        <li><a href="#newPage" role="tab" data-toggle="tab"><?php echo _uc($_e['Add New Shift']); ?></a></li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active container-fluid" id="home">
            <h2  class="tab_heading"><?php echo _uc($_e['Shift']); ?></h2>
            <?php $rota->shiftView();  ?>
        </div>
        ...
        <div class="tab-pane fade in container-fluid" id="newPage">
            <h2  class="tab_heading"><?php echo _uc($_e['Add New Shift']); ?></h2>
            <?php $rota->shiftNew();  ?>
        </div>
    </div>
...
<script>
    ...
    function deleteshift(ths){
        ...
        if(secure_delete()){
            ...
            $.ajax({
                type: 'POST',
                url: 'rota/rota_ajax.php?page=deleteshift',
                data: { id:id }
            }).done(function(data)
                {
                    ift =true;
