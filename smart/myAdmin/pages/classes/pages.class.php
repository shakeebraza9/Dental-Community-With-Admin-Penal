...
$sql_slug = "SELECT * FROM pages where slug = ? ";
...
$publish,$comment,$returnImage,$returnImages,$special_page);
$this->dbF->setRow($sql,$array,false);
$var = $this->functions->setting_fieldsSet($lastId,'pages',false);
//var_dump($_POST);
...
$id = $_GET['pageId'];
$sql = "SELECT * FROM pages where page_pk = ? ";
...
$special_subhead_css = 'displaynone11111111111111';
...
echo '          <div class="form-group">
<label class="col-sm-2 col-md-3  control-label">'. _uc($_e['Banner Content']) .'</label>
<div class="col-sm-10  col-md-9">
<textarea name="short_desc['.$lang[$i].']" class="ckeditor" placeholder="'. _uc($_e['Enter Banner Content']) .'" maxlength="500">'.@$short_desc[$lang[$i]].'</textarea>
</div>
</div>';
}else{ echo '<input type="hidden" name="short_desc['.$lang[$i].']" value="" class="ckeditor">';}
...
// echo '<div class="form-group">
// <label  class="col-sm-2 col-md-3  control-label">'. _uc($this->dbF->hardWords('Recommened Banner Image Size: 1400 x 800 px', false)) .' </label><br>
// <div class="col-sm-10  col-md-9">
...
echo '<div class="form-group">
<label  class="col-sm-2 col-md-3  control-label">'. _uc($this->dbF->hardWords('Recommened Content Image Size: 1920 x 446 px', false)) .' </label><br>
<div class="col-sm-10  col-md-9">
...
<tr><td>'. _n('use : {{contactForm}}  FOR Print CONTACT FORM') .'</td></tr>
<tr><td>'. _n('use : {{All_Services}} FOR Print Services') .'</td></tr>
<tr><td>'. _n('use : {{Training_Academy}} FOR Print Training Academy') .'</td></tr>
<tr><td>'. _n('use : {{Testimonial}} FOR Print Testimonial') .'</td></tr>
<tr><td>'. _n('use : {{Business-Consultancy}} FOR Print Business Consultancy') .'</td></tr>
...
$id     =   $_GET['pageId'];
$sql    =   "SELECT * FROM box where id = ? AND publish = ? ";
...
$boxName = $data['box'];
$sql     =   "SELECT * FROM box_setting where box = ? ";
$box_setting  =   $this->dbF->getRow($sql,array($boxName));
if($this->dbF->rowCount==0){
...
$boxes = array( 
'41box1'  => ' Recommended size ( 1920 X 1080 px ) ',
'41box4'  => ' Recommended size ( 1200 X 800 px ) ', 
'41box5'  => ' Recommended size ( 5366 X 3577 px ) ', 
'41box6'  => ' Recommended size ( 1200 X 800 px ) ', 
'41box7' => ' Recommended size ( 3840 X 2160 px ) ',
'41box8' => ' Recommended size ( 2048 X 1365 px ) ',
'41box9' => ' Recommended size ( 2000 X 1168 px ) ',
'41box11' => ' Recommended size ( 1400 X 800 px ) ',
'41box12' => ' Recommended size ( 5366 X 2246 px ) '
);
