...
?>
<h2 class="sub_heading"><?php echo _uc($_e['Add Event']); ?></h2>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist">
        ...
        <li class="active"><a href="#newPage" role="tab" data-toggle="tab"><?php echo _uc($_e['Add New Event']); ?></a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade in active container-fluid" id="newPage">
