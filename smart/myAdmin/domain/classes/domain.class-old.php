...
$sql  =  "INSERT INTO `subjects`(`subject_title`,`expiration`,`minutes`,`image`,`link`,`subject_desc`,test_category,`under`,`publish`) VALUES (?,?,?,?,?,?,?,?,?)";

$array   = array($title,$expiration,$minutes,$image,$link,$desc,$test_category,$under,$publish);
...
$array   = array($title,$expiration,$minutes,$image,$link,$desc,$test_category,$under,$publish,$lastId);
