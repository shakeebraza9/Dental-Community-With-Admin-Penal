...
if (@$_GET['id'] !='') {
 ...
 $array = array($getId);
 $data = $dbF->getRow($sql,$array,false);
...
<div class="event_details" id="myform">
    ...
    <div class="row">
            ...
            <?php echo $functions->setFormToken($token,false); ?>
                <input name="editID" value="<?php echo $data['id'] ?>" type="hidden">
            <div class="form-group col-12 col-md-6">
                <label>Shift Name</label>
                <input name="shift_name" value="<?php echo $data['shift_name'] ?>" placeholder="Shift Name" type="text" >
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                ...
                <select name="dentist_id">
                    ...
                    <?php echo $functions->allDentist($_SESSION['currentUser'],$data['dentist_id']) ?>
                </select>
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Time From</label>
                <input class="time_picker" name="timefrom" placeholder="Time From" type="text" autocomplete="off" value="<?php echo $data['timefrom'] ?>"  >
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Time To</label>
                <input class="time_picker" value="<?php echo $data['timeto'] ?>" name="timeto" placeholder="Time To" type="text" autocomplete="off"  >
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Break</label>
    <select name="break" >
     <option value="00:00" <?php if($data["break"] == "00:00"){echo "selected";} ?>>No Break</option>
    <option value="00:15" <?php if($data["break"] == "00:15"){echo "selected";} ?>>15 Minutes</option>
    <option value="00:30" <?php if($data["break"] == "00:30"){echo "selected";} ?>>30 Minutes</option>
    <option value="00:45" <?php if($data["break"] == "00:45"){echo "selected";} ?>>45 Minutes</option>
    <option value="01:00" <?php if($data["break"] == "01:00"){echo "selected";} ?>>1 Hour</option>
    <option value="01:30" <?php if($data["break"] == "01:30"){echo "selected";} ?>>1.5 Hour</option>
                </select>
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Color</label>
                <!-- <input name="color" placeholder="Color" type="color" required>
                 -->
                 <select name="color">
    <option  disabled="" selected="">Select Color</option>  
    <?php if($data['color'] !=''){echo '<option value="'.$data['color'].'" selected>'.$data['color'].'</option>';} ?>
...
<option value="White" style="background:white;">White</option>
            ...
            <div class="col-12">
                ...
                <input type="submit" class="submit_class" value="Submit" id="submit">
            </div>
         </div><!-- END ROW-->
        <script>
$(document).ready(function() {
    ...
    $('#submit').click(function() {
        ...
        dentist_id = $('select[name=dentist_id]').val();
        timefrom = $('input[name=timefrom]').val();
        timeto = $('input[name=timeto]').val();
        tbreak = $('select[name=break]').val();
        color = $('select[name=color]').val();
        if (shift_name == '' || dentist_id == '' || timefrom == '' || timeto == '' || tbreak == ''|| editID == '') {
            ...
            $.ajax({
                ...
                url: 'ajax_call.php?page=editShift',
            }).done(function(data) {
                if (data == '1') {
                    location.reload();
                } else {
    ...
    {?>
        <div class="row">
            <?php echo $functions->setFormToken("addShift",false); ?>
            <div class="form-group col-12 col-md-6">
                <label>Shift Name</label>
            ...
            <div class="form-group col-12 col-md-6">
                ...
                <select name="dentist_id">
                    <option selected disabled>Select Dentist</option>
                    <?php echo $functions->allDentist($_SESSION['currentUser']) ?>
                </select>
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Time From</label>
                <input class="time_picker" name="timefrom" placeholder="Time From" type="text" autocomplete="off" readonly required>
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Time To</label>
                <input class="time_picker" name="timeto" placeholder="Time To" type="text" autocomplete="off" readonly required>
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
                <label>Break</label>
                <select name="break" required>
                    ...
                    <option value="01:30">1.5 Hour</option>
                </select>
            </div>
            <!-- form-group -->
            <div class="form-group col-12 col-md-6">
...
$(document).ready(function() {
    ...
    $('#submit').click(function() {
        ...
        tbreak = $('select[name=break]').val();
        color = $('select[name=color]').val();
        if (shift_name == '' || dentist_id == '' || timefrom == '' || timeto == '' || tbreak == '') {
            $('.errmsg').text('All Fields Required');
        }
        else{
            $(this).attr('disabled', true);
            ...
            $.ajax({
                ...
                url: 'ajax_call.php?page=addShift',
            }).done(function(data) {
                if (data == '1') {
                    location.reload();
                } else {
